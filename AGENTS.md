...
**Active authorized roadmap (W130):** `docs/roadmaps/CVF_W130_T1_NONCODER_EVIDENCE_AND_PACK_EXPORT_ACTIVATION_ROADMAP_2026-04-28.md`. GC-018 issued 2026-04-28. W130 is IN PROGRESS. Fresh GC-018 required for W131 and beyond.

Treat the W113/W116/W117/W118/W119/W122/W123/W124/W125/W126/W127/W128/W129/W130 boundary language as binding:
...
- W130 is authorized to make the noncoder evidence receipt and deliverable pack the default exit from a noncoder execution session: `ResultViewer` noncoder export nudge + pack tab priority; `w130-evidence-pack-export.live.spec.ts` must fire `evidence_exported` + `deliverable_pack_exported`; both `evidence_export` and `deliverable_pack` W128 lanes must exit `no_data`. No new flags, no routing changes, no governance path changes. GC-018 issued 2026-04-28 (depth 9/10). W131 requires fresh GC-018.
