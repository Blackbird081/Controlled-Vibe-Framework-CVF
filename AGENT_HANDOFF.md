...
- **Public Release Candidate + Demo Readiness DELIVERED (2026-04-21)**: roadmap `docs/roadmaps/CVF_PUBLIC_RELEASE_CANDIDATE_AND_DEMO_READINESS_ROADMAP_2026-04-21.md` is verified CP1-CP5, with release gate bundle PASS 5/5 in mock mode. Core artifacts: truth packet, demo script, known limitations register, release gate bundle, README/docs index navigation. Delta: `docs/baselines/CVF_PUBLIC_RELEASE_CANDIDATE_AND_DEMO_READINESS_DELTA_2026-04-21.md`.
