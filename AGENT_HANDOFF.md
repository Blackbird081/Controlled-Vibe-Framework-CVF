...
W129-T1 is CLOSED DELIVERED. **W130-T1 AUTHORIZED (2026-04-28)** — GC-018 issued (depth 9/10). Active tranche: **W130-T1 — Noncoder Evidence And Pack Export Activation**. Scope: `ResultViewer` export nudge + pack tab priority + E2E proof + both `evidence_export` and `deliverable_pack` lanes exit `no_data`. Roadmap: `docs/roadmaps/CVF_W130_T1_NONCODER_EVIDENCE_AND_PACK_EXPORT_ACTIVATION_ROADMAP_2026-04-28.md`.

- **W130-T1 — Noncoder Evidence And Pack Export Activation AUTHORIZED (2026-04-28)**: GC-018: `docs/baselines/CVF_GC018_W130_T1_NONCODER_EVIDENCE_AND_PACK_EXPORT_ACTIVATION_AUTHORIZATION_2026-04-28.md` (depth 9/10). Roadmap: `docs/roadmaps/CVF_W130_T1_NONCODER_EVIDENCE_AND_PACK_EXPORT_ACTIVATION_ROADMAP_2026-04-28.md`. Quality assessment: `docs/assessments/CVF_POST_W129_CONTINUATION_QUALITY_ASSESSMENT_2026-04-28.md`. Problem: `evidence_export=no_data` + `deliverable_pack=no_data` after full W129 rollout — export affordances are functionally complete but visually buried. Deliverables: CP0 export activation contract; CP1 `ResultViewer` noncoder export nudge; CP2 pack tab priority in noncoder mode; CP3 `w130-evidence-pack-export.live.spec.ts` (fires `evidence_exported` + `deliverable_pack_exported`); CP4 lane exit verification; CP5 handoff + GC-026. No new flags, no routing changes, no governance path changes.
