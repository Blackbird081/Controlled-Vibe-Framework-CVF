...
- **Default next tranche: W94-T1** — Risk Visibility. Use `risk-check.ts` + `safety-status.ts`; add R0/R1/R2/R3 badge to main non-coder flow. Fast Lane (GC-021) per roadmap. Measurement standard §9.
- **Next-agent boundary post-W93**: Gates 1–4 MET/DELIVERED (W90/W91/W92/W93). No active tranche. W94-T1 is Fast Lane — use `docs/reference/CVF_FAST_LANE_AUDIT_TEMPLATE.md` instead of GC-018.
