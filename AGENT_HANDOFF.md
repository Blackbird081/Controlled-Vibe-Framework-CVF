...
> State: **UNIFIED ON MAIN / W114-W117 CLOSED** — core architecture remains closure-assessed and closed-by-default; redesign wave `W105-T1` through `W109-T1` is delivered; strict front door is all-trusted (`42` skills / `50` linked templates / `50/50` trusted); W114 CP1-CP8 CLOSED DELIVERED with bounded live-vs-workspace evidence claims; W115 Non-Coder Onboarding Experience, W116 Downstream Knowledge Pipeline, and W117 D1.4b RAG Chunk Enforcement are closed delivered. No further planned tranches are recorded here. Any core reopen still requires a fresh `GC-018`.
