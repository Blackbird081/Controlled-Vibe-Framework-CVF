...
- **W113-T1 — First Downstream Project Proof APPROVED ROADMAP (2026-04-22)**: canonical active roadmap is `docs/roadmaps/CVF_W113_T1_FIRST_DOWNSTREAM_PROJECT_PROOF_ROADMAP_2026-04-22.md`. Goal: prove W112 workspace enforcement in a real downstream project outside CVF core. Required closure: downstream bootstrap artifact inventory, workspace doctor PASS, first-request agent declaration, full `INTAKE -> DESIGN -> BUILD -> REVIEW -> FREEZE` downstream run, live API-backed governance evidence, hook/CI adoption proof, and first-project docs refresh. Do not claim downstream adoption proof before W113 evidence exists.
