...
W130-T1 is CLOSED DELIVERED. **No active tranche is pre-authorized (2026-04-28)** — W130 moved both export lanes out of `no_data`; W131 requires fresh GC-018 after post-W130 traffic readout. Latest closed roadmap: `docs/roadmaps/CVF_W130_T1_NONCODER_EVIDENCE_AND_PACK_EXPORT_ACTIVATION_ROADMAP_2026-04-28.md`.
