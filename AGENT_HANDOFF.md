...
- **P3/CP4 completed**: `CVF_SKILL_LIBRARY/` and `ui_governance_engine/` were relocated out of the visible repo root into `ECOSYSTEM/reference-roots/`; both remain internal retained lineage, but no longer consume top-level root attention
