...
import { DURABLE_AUDIT_INTEGRITY_READOUT_CONTRACT, } from './durable-execution-audit-readout.js';
export const DURABLE_AUDIT_EVIDENCE_BUNDLE_CONTRACT = 'cvf.delta.durableAuditEvidenceBundle.v1';
...
function buildClaimMatrix(readout) {
...
function validateReadoutBoundary(readout) {
...
export function buildDurableAuditEvidenceBundle(_records, readout, options) {
...
export function renderDurableAuditEvidenceBundleMarkdown(bundle) {
    const lines = [];
...
//# sourceMappingURL=durable-audit-evidence-bundle.js.map