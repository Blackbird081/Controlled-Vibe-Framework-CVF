...
export const PHASE_ROLE_MATRIX = {
...
export class PhaseGateGuard {
    ...
    evaluate(context) {
        ...
        if (!allowedRoles.includes(context.role)) {
            ...
            const allowedPhases = PHASE_ORDER.filter((p) => PHASE_ROLE_MATRIX[p].includes(context.role));
            return {
                guardId: this.id,
                decision: 'BLOCK',
                severity: 'ERROR',
...
//# sourceMappingURL=phase-gate.guard.js.map