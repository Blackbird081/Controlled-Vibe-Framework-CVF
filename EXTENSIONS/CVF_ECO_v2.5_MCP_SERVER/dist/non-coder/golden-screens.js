 ...
 */
export function generateVibeBoxScreen(recentVibes = [], currentPhase = 'DISCOVERY') {
    const phasePrompts = {
        DISCOVERY: [
...
export function generateIntentionMapScreen(parsed, clarification, card) {
    const nodes = [];
    // Goal node
    const goalNode = {
        id: 'goal-root',
...
export function generateLiveDashboardScreen(snapshot, currentStep = 1, totalSteps = 4, isPaused = false) {
    const riskBudgets = { R0: 10, R1: 10, R2: 5, R3: 0 };
...
export function generateHITLScreen(pipelineResult) {
    const notifications = [];
...
function mapGuardToNotificationType(guardId) {
    switch (guardId) {
...
export function generateAuditLedgerScreen(auditLog) {
...
//# sourceMappingURL=golden-screens.js.map