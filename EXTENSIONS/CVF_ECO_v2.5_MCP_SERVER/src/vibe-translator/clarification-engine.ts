...
const SLOT_QUESTIONS: Record<string, Omit<ClarificationQuestion, 'slot'>> = {
  action_type: {
...
const ADDITIONAL_SLOTS: Record<VibeActionType, string[]> = {
  create: ['format'],
  modify: [],
  delete: [],
  send: ['schedule'],
...
export function generateClarifications(parsed: ParsedVibe): ClarificationResult {
