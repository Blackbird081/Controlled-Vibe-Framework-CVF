 ...
 */
export function produceVerificationResults(request, stores, deps) {
    const results = [];
 ...
 */
export function computeDecision(request, admission, verificationResults, stores) {
    ...
    const blockingVerification = verificationResults.some((result) => result.status === "FAIL" || result.status === "BLOCKED");
