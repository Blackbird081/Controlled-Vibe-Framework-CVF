...
- Cần Code Reviewer với tiêu chí rõ ràng
...
- UAT Record: [code_reviewer](../../../governance/skill-library/uat/results/UAT-code_reviewer.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Code Reviewer cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/google-gemini/gemini-cli/tree/main/.gemini/skills/code-reviewer
...
**Input mẫu:**
```text
Objective: Code Reviewer cho ứng dụng quản lý công việc
...
## Summary
- Goal: Code Reviewer cho ứng dụng quản lý công việc
