...
- Cần Content Re Earch Writer với tiêu chí rõ ràng
...
- UAT Record: [content_research_writer](../../../governance/skill-library/uat/results/UAT-content_research_writer.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Content Re Earch Writer cho sản phẩm SaaS nhỏ" |
...
```markdown
# Content Re Earch Writer Output
...
- Nguồn tham khảo: https://github.com/ComposioHQ/awesome-claude-skills/tree/master/content-research-writer
...
**Input mẫu:**
```text
Objective: Content Re Earch Writer cho ứng dụng quản lý công việc
...
## Summary
- Goal: Content Re Earch Writer cho ứng dụng quản lý công việc
