...
- Cần Doc Writer Reference với tiêu chí rõ ràng
...
- UAT Record: [docs_writer_reference](../../../governance/skill-library/uat/results/UAT-docs_writer_reference.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Doc Writer Reference cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/reactjs/react.dev/tree/main/.claude/skills/docs-writer-reference
...
**Input mẫu:**
```text
Objective: Doc Writer Reference cho ứng dụng quản lý công việc
...
## Summary
- Goal: Doc Writer Reference cho ứng dụng quản lý công việc
