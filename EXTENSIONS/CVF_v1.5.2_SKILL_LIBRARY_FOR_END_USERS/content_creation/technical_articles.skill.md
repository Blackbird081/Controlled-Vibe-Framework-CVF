...
- Cần Technical Article với tiêu chí rõ ràng
...
- UAT Record: [technical_articles](../../../governance/skill-library/uat/results/UAT-technical_articles.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Technical Article cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/EpicenterHQ/epicenter/tree/main/.agents/skills/technical-articles
...
**Input mẫu:**
```text
Objective: Technical Article cho ứng dụng quản lý công việc
...
## Summary
- Goal: Technical Article cho ứng dụng quản lý công việc
