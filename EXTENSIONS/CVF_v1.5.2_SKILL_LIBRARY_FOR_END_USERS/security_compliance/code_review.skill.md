...
- Cần Code Review với tiêu chí rõ ràng
...
- UAT Record: [code_review](../../../governance/skill-library/uat/results/UAT-code_review.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Code Review cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/shareAI-lab/learn-claude-code/tree/main/skills/code-review
...
**Input mẫu:**
```text
Objective: Code Review cho ứng dụng quản lý công việc
...
## Summary
- Goal: Code Review cho ứng dụng quản lý công việc
