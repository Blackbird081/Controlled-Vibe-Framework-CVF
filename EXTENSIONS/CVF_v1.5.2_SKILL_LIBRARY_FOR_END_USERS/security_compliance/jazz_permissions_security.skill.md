...
- Cần Jazz Permi Ion Ecurity với tiêu chí rõ ràng
...
- UAT Record: [jazz_permissions_security](../../../governance/skill-library/uat/results/UAT-jazz_permissions_security.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Jazz Permi Ion Ecurity cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/garden-co/jazz/tree/main/.cursor/skills/jazz-permissions-security
...
**Input mẫu:**
```text
Objective: Jazz Permi Ion Ecurity cho ứng dụng quản lý công việc
...
## Summary
- Goal: Jazz Permi Ion Ecurity cho ứng dụng quản lý công việc
