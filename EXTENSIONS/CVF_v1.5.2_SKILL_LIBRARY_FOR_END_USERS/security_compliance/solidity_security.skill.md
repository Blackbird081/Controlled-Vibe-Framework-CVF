...
- Cần Olidity Ecurity với tiêu chí rõ ràng
...
- UAT Record: [solidity_security](../../../governance/skill-library/uat/results/UAT-solidity_security.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Olidity Ecurity cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/scaffold-eth/scaffold-eth-2/tree/main/.agents/skills/solidity-security
...
**Input mẫu:**
```text
Objective: Olidity Ecurity cho ứng dụng quản lý công việc
...
## Summary
- Goal: Olidity Ecurity cho ứng dụng quản lý công việc
