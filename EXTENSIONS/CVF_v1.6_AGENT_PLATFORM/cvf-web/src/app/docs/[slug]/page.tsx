...
const DOC_META: Record<string, DocMeta> = {
    ...
    'solo-developer': {
        ...
        category: { vi: 'Hướng Dẫn', en: 'Guides' },
        categoryIcon: '📖',
    },
    'team-setup': {
    ...
    'first-project': {
        ...
        category: { vi: 'Tutorials', en: 'Tutorials' },
        categoryIcon: '📝',
    },
    'web-ui-setup': {
    ...
    'core-philosophy': {
        ...
        category: { vi: 'Khái Niệm', en: 'Concepts' },
        categoryIcon: '💡',
    },
    '4-phase-process': {
    ...
    'version-picker': {
        ...
        category: { vi: 'Tham Khảo', en: 'Reference' },
        categoryIcon: '🔧',
    },
    'troubleshooting': {
    ...
    'case-fintech': {
        title: { vi: 'Case Study: Fintech', en: 'Case Study: Fintech' },
        category: { vi: 'Case Studies', en: 'Case Studies' },
        categoryIcon: '📊',
    },
    'case-healthcare': {
        title: { vi: 'Case Study: Healthcare', en: 'Case Study: Healthcare' },
        category: { vi: 'Case Studies', en: 'Case Studies' },
        categoryIcon: '📊',
    },
    'case-ecommerce': {
        title: { vi: 'Case Study: E-commerce', en: 'Case Study: E-commerce' },
        category: { vi: 'Case Studies', en: 'Case Studies' },
        categoryIcon: '📊',
    },
};
