...
const QUICK_TIPS: Record<Lang, QuickTip[]> = {
    vi: [
        ...
        { icon: '📚', title: 'Skills ↔ Templates', content: 'Thư viện skill front-door giờ đã sync theo trusted/review subset; benchmark truth vẫn chỉ dựa trên TRUSTED_FOR_VALUE_PROOF' },
    ...
    en: [
        ...
        { icon: '📚', title: 'Skills ↔ Templates', content: 'The front-door skill library is now synced to the trusted/review subset; benchmark truth still depends on TRUSTED_FOR_VALUE_PROOF only' },
