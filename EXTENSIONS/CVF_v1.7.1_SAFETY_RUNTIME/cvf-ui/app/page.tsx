...
const recentProposals = [
  ...
  {
    id: "p-003",
    action: "Grant admin role to @user3",
    source: "structured",
    riskLevel: "high",
    state: "rejected",
    time: "1 hr ago",
...
const activityFeed = [
  ...
  {
    text: "Rate limit triggered for 192.168.1.42",
    color: "var(--cvf-warning)",
    time: "10:28",
  },
  {
    text: "Proposal p-002 awaiting approval",
    color: "var(--cvf-pending)",
    time: "10:15",
  },
  {
    text: "AI usage: 12,500 tokens (OpenAI)",
    color: "var(--cvf-text-muted)",
    time: "10:02",
  },
  {
    text: "Auth: admin login from new device",
          ...
          <tbody>
            {recentProposals.map((p) => (
              <tr key={p.id}>
                ...
                <td style={{ color: "var(--cvf-text-muted)", fontSize: "12px" }}>
                  {p.time}
                </td>
              </tr>
            ))}
