    ...
    <div className="cvf-animate-in">
      <div className="cvf-page-header">
        ...
        <p className="cvf-page-subtitle">
          Create and submit proposals through the CVF pipeline
        </p>
      </div>
              ...
              {i < pipelineSteps.length - 1 && (
                <div
                  style={{
                    ...
                    flex: "0 0 20px",
                    background:
                      step.status === "done" ? stepColors.done : "var(--cvf-border)",
                    marginBottom: "24px",
                  }}
                />
              )}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            >
              ...
              {instruction.length > 500 ? "— High risk threshold" : ""}
            </span>
          </div>

          <div style={{ display: "flex", gap: "12px" }}>
            <button
              className="cvf-btn cvf-btn-primary"
            ...
            <button
              className="cvf-btn cvf-btn-outline"
              onClick={() => {
                setInstruction("")
                setSubmitted(false)
              }}
