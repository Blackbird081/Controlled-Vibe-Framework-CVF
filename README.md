...
- **Governed Starter Handoff** — onboarding + Quick Start route non-coder intent into a reviewable starter wizard handoff before live execution
...
| **Current System Review** | [Independent system checkpoint](docs/reviews/CVF_INDEPENDENT_SYSTEM_CHECKPOINT_2026-03-20.md) — current whole-system readout after the active remediation wave, compared against the `2026-03-19` independent review baseline |
| **Closure Review** | [Active-wave closure review](docs/reviews/CVF_SYSTEM_UNIFICATION_ACTIVE_WAVE_CLOSURE_REVIEW_2026-03-20.md) — confirms this roadmap is closed for the current wave and only reassessment or a fresh `GC-018` candidate may reopen work |
| **Current Reassessment Trigger** | [Post-closure reassessment hold](docs/reviews/CVF_POST_CLOSURE_REASSESSMENT_TRIGGER_HOLD_2026-03-20.md) — records that no fresh material signal currently justifies reopening independent reassessment on the active wave |
| **Release Readiness** | [Local readiness status](docs/reference/CVF_RELEASE_READINESS_STATUS_2026-03-20.md) — governance-first control plane with reusable coder-facing and nine active non-coder governed reference paths; the active wave is now depth-frozen, with breadth defer recorded in [GC-018 continuation candidate P3](docs/reviews/CVF_GC018_CONTINUATION_CANDIDATE_P3_2026-03-20.md) and reassessment currently held in [post-closure reassessment trigger hold](docs/reviews/CVF_POST_CLOSURE_REASSESSMENT_TRIGGER_HOLD_2026-03-20.md) |
