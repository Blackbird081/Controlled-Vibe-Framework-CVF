...
git clone https://github.com/YOUR_ORG/Controlled-Vibe-Framework-CVF.git my-new-project
...
git submodule add https://github.com/YOUR_ORG/Controlled-Vibe-Framework-CVF.git cvf
```
