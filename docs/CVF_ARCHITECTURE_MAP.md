...
│  │  ├── state_enforcement  (GOVERNANCE_PIPELINE slot 1)     │   │
│  │  ├── diagram_validation (GOVERNANCE_PIPELINE slot 2)     │   │
│  │  ├── structural_diff    (GOVERNANCE_PIPELINE slot 3)     │   │
│  │  ├── scenario_simulator (GOVERNANCE_PIPELINE slot 4)     │   │
│  │  ├── artifact_integrity (GOVERNANCE_PIPELINE slot 5)     │   │
...
|---|---|---|
| `state_enforcement/` | `detectDeadlocks()` + dead-end detection | 1 |
| `diagram_validation/` | Diagram-state consistency | 2 |
| `structural_diff/` | Architecture drift | 3 |
| `scenario_simulator/` | `detectAnomalies()` + `checkInvariants()` | 4 |
| `artifact_integrity/` | `verifyAllHashes()` + Trust Boundary | 5 |
...
| I want the Whitepaper | `docs/CVF_WHITEPAPER_GIT_FOR_AI.md` |
| I want adoption guidance | `docs/CVF_ADOPTION_STRATEGY.md` |
