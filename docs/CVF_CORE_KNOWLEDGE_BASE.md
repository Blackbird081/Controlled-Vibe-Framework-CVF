...
| v1.5.2 | Skill Library (62 active skills) | 1 | Active ✅ | `CVF_v1.5.2_SKILL_LIBRARY_FOR_END_USERS/` |
...
| Thuộc tính | Giá trị |
|---|---|
| Tổng số skills | **62 active skills** |
...
| Skills | 62 active skills, 12 domains |
| Agent Tools | 34 tools |
