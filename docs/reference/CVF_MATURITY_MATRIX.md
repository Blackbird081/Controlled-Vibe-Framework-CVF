...
| v1.1.1 | candidate | integrated + independently reviewed | stable |
| v1.1.2 | local-implemented | focused local tests + upgrade trace | local-ready |
...
- `local-implemented` means the code/docs exist and may pass local verification, but release narrative and ecosystem positioning are not fully normalized yet
