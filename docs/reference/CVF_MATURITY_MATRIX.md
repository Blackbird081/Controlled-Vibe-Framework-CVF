...
| W1-T1 / W1-T2 control-plane line | local-implemented | closed control-plane tranche plus bounded usable-intake contract baseline, unified knowledge retrieval contract, and deterministic context packaging contract with local verification and regression receipts | local-ready |
