...
| W1-T1 / W1-T2 control-plane line | local-implemented | closed control-plane tranche plus bounded usable-intake contract baseline, unified knowledge retrieval contract, deterministic context packaging contract, and real consumer path proof with local verification and regression receipts | local-ready |
