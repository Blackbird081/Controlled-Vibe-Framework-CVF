...
| `EXTENSIONS/CVF_CONTROL_PLANE_FOUNDATION/` | control-plane coordination shell | whitepaper completion `W1-T1 / CP1` | local-ready | coordination package preserving lineage for intent, knowledge, reporting, and context freeze |
