...
| W2-T1 | Execution Plane Foundation Shell | local-ready | implemented-local | `EXTENSIONS/CVF_EXECUTION_PLANE_FOUNDATION/` | first execution-plane shell for whitepaper completion, preserving gateway and MCP lineage |
