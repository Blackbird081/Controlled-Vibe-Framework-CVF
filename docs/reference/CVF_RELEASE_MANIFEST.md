...
| W1-T1 / W1-T2 | Control Plane Foundation | local-ready | implemented-local | `EXTENSIONS/CVF_CONTROL_PLANE_FOUNDATION/` | closed first control-plane tranche and now extended with a bounded usable-intake contract baseline (`W1-T2 / CP1`) and a unified knowledge retrieval contract (`W1-T2 / CP2`) |
