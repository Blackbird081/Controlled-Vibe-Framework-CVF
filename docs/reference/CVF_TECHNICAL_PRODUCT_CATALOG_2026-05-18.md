...
| Governance benchmark live metrics | proven — bounded 5-call hosted Alibaba/qwen-turbo benchmark window; measured `taskCompletionRate=0.5`, `policyViolationRate=0`, `receiptIntegrityRate=0.5` under the current E2 event model; no SLA or production-readiness claim | `docs/evidence/governance-benchmark-live-metrics-2026-05-24.md` |
