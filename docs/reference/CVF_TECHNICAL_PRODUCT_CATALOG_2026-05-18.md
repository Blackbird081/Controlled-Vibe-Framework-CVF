...
| Capability admission and distribution profile (CADP) | bounded internal foundation validated; public runtime surface not shipped | public-safe status and system-chain boundary: `docs/reference/CVF_CADP_CAPABILITY_ADMISSION_FOUNDATION_PUBLIC_SNAPSHOT_2026-08-15.md`; public admission doctrine: `docs/reference/CVF_EXTERNAL_CAPABILITY_ADMISSION_CONTRACT.md`; no public endpoint, registry row, MCP/CLI adapter, or production-readiness claim |
