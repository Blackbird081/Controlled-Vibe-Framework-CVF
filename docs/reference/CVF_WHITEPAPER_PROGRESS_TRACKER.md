...
> Last refreshed: `2026-04-17` (latest governed closure `W98-T1 CLOSED DELIVERED`; E2E Success Rate Benchmark; E2E VALUE PARTIAL; 8/8 completed runs usable; 7/7 HIGH_RISK intercepted; authority_gate OPERATOR gap documented; no active tranche)
...
| Current active tranche | `NONE — W98-T1 CLOSED DELIVERED 2026-04-17; E2E VALUE PARTIAL; next tranche requires fresh GC-018 authorization` |
...
- Latest GC-026 tracker sync: `docs/baselines/CVF_GC026_TRACKER_SYNC_W98_T1_CLOSED_2026-04-17.md` (W98-T1 CLOSED DELIVERED; E2E Benchmark; E2E VALUE PARTIAL; no active tranche)
...
- Active quality assessment: `docs/assessments/CVF_W98_T1_POST_RUN_QUALITY_ASSESSMENT_2026-04-17.md` (W98-T1 post-run assessment; E2E Benchmark; E2E VALUE PARTIAL; 8/8 completed runs usable; OFU-1/OFU-2/OFU-3 open)
- Most recent continuation authorization: `docs/baselines/CVF_GC018_W98_T1_E2E_BENCHMARK_AUTHORIZATION_2026-04-17.md` (W98-T1 Full Lane GC-018 AUTHORIZED; E2E Success Rate Benchmark; R0 benchmark-only)
