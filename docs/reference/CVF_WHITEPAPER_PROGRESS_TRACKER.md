...
> Last refreshed: `2026-03-24` (W2-T13 closed delivered)
...
| Current active tranche | `NONE — LAST CANONICAL CLOSURE W2-T13` |
...
| Current canonical validation posture | `NO AUTHORIZED ACTIVE TRANCHE — LAST CLOSED W2-T13` |
