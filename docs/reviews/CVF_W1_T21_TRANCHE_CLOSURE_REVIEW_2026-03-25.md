...
| GC-026 auth sync | `docs/baselines/CVF_GC026_TRACKER_SYNC_W1_T21_AUTHORIZATION_2026-03-25.md` |
| Execution plan | `docs/roadmaps/CVF_W1_T21_CLARIFICATION_REFINEMENT_CONSUMER_PIPELINE_BRIDGE_EXECUTION_PLAN_2026-03-25.md` |
| CP1 audit | `docs/audits/CVF_W1_T21_CP1_CLARIFICATION_REFINEMENT_CONSUMER_PIPELINE_AUDIT_2026-03-25.md` |
| CP1 review | `docs/reviews/CVF_GC019_W1_T21_CP1_CLARIFICATION_REFINEMENT_CONSUMER_PIPELINE_REVIEW_2026-03-25.md` |
| CP1 delta | `docs/baselines/CVF_W1_T21_CP1_CLARIFICATION_REFINEMENT_CONSUMER_PIPELINE_DELTA_2026-03-25.md` |
| CP2 audit | `docs/audits/CVF_W1_T21_CP2_CLARIFICATION_REFINEMENT_CONSUMER_PIPELINE_BATCH_AUDIT_2026-03-25.md` |
| CP2 review | `docs/reviews/CVF_GC021_W1_T21_CP2_CLARIFICATION_REFINEMENT_CONSUMER_PIPELINE_BATCH_REVIEW_2026-03-25.md` |
| CP2 delta | `docs/baselines/CVF_W1_T21_CP2_CLARIFICATION_REFINEMENT_CONSUMER_PIPELINE_BATCH_DELTA_2026-03-25.md` |
| Closure review | `docs/reviews/CVF_W1_T21_TRANCHE_CLOSURE_REVIEW_2026-03-25.md` |
| GC-026 closure sync | `docs/baselines/CVF_GC026_TRACKER_SYNC_W1_T21_CLOSURE_2026-03-25.md` |
