...
| `W1-T1 / CP4` selected controlled-intelligence surface alignment packet chain | audit and independent review issued for a narrow wrapper/re-export boundary; execution still gated | `REVIEWABLE / NOT EXECUTED` |
