...
| Learning-plane `Evaluation Engine / feedback loop` | conceptual direction only; TruthModel foundation in place to support evaluation engine | `PARTIAL / FUTURE W4 TRANCHES` |
