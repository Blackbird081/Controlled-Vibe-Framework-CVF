...
| `Post-P5` Isolation Scope Batch (REALIZATION class) | `GC-018 AUTHORIZED 2026-03-30 — W19-T1; IsolationScopeBatchContract; evaluateIsolationScope() batch surface; CPF 2252; CP1 Full Lane next` |
