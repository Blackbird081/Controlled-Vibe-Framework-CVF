...
| `Post-P5` Trust Propagation Batch (REALIZATION class) | `GC-018 AUTHORIZED 2026-03-30 — W20-T1; TrustPropagationBatchContract; decideTrustPropagation() batch surface; CPF 2278; CP1 Full Lane next` |
