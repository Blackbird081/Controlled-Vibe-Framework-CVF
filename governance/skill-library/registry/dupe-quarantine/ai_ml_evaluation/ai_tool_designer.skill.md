...
- Cần Ai Tool De Igner với tiêu chí rõ ràng
...
- UAT Record: [ai_tool_designer](../../../governance/skill-library/uat/results/UAT-ai_tool_designer.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Ai Tool De Igner cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/nityeshaga/claude-code-essentials/tree/main/plugins/basics/skills/ai-tool-designer
