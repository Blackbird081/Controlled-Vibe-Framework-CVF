...
- Cần Azure Ai Evaluation Py với tiêu chí rõ ràng
...
- UAT Record: [azure_ai_evaluation_py](../../../governance/skill-library/uat/results/UAT-azure_ai_evaluation_py.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Azure Ai Evaluation Py cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/microsoft/skills/tree/main/.github/skills/azure-ai-evaluation-py
...
**Input mẫu:**
```text
Objective: Azure Ai Evaluation Py cho ứng dụng quản lý công việc
...
## Summary
- Goal: Azure Ai Evaluation Py cho ứng dụng quản lý công việc
