...
- Cần Karen Repo Reviewer với tiêu chí rõ ràng
...
- UAT Record: [karen_repo_reviewer](../../../governance/skill-library/uat/results/UAT-karen_repo_reviewer.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Karen Repo Reviewer cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/pr-pm/prpm/tree/main/.claude/skills/karen-repo-reviewer
