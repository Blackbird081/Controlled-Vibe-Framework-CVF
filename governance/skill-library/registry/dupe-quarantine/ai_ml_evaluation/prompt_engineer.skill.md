...
- Cần Prompt Engineer với tiêu chí rõ ràng
...
- UAT Record: [prompt_engineer](../../../governance/skill-library/uat/results/UAT-prompt_engineer.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Prompt Engineer cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/Jeffallan/claude-skills/tree/main/skills/prompt-engineer
