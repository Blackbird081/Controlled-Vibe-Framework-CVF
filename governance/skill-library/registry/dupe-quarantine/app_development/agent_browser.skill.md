...
- Cần Agent Brow Er với tiêu chí rõ ràng
...
- UAT Record: [agent_browser](../../../governance/skill-library/uat/results/UAT-agent_browser.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Agent Brow Er cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/baptisteArno/typebot.io/tree/main/.agents/skills/agent-browser
