...
- Cần Agent Device với tiêu chí rõ ràng
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Agent Device cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/callstackincubator/agent-device/tree/main/skills/agent-device
