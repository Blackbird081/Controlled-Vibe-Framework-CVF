...
- Cần Azure Devop Re T Api với tiêu chí rõ ràng
...
- UAT Record: [azure_devops_rest_api](../../../governance/skill-library/uat/results/UAT-azure_devops_rest_api.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Azure Devop Re T Api cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/Tiberriver256/mcp-server-azure-devops/tree/main/.github/skills/azure-devops-rest-api
