...
- Cần Brow Er U E với tiêu chí rõ ràng
...
- UAT Record: [browser_use](../../../governance/skill-library/uat/results/UAT-browser_use.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Brow Er U E cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/browser-use/browser-use/tree/main/skills/browser-use
...
**Input mẫu:**
```text
Objective: Brow Er U E cho ứng dụng quản lý công việc
...
## Summary
- Goal: Brow Er U E cho ứng dụng quản lý công việc
