...
- Cần Chatgpt App Builder với tiêu chí rõ ràng
...
- UAT Record: [chatgpt_app_builder](../../../governance/skill-library/uat/results/UAT-chatgpt_app_builder.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Chatgpt App Builder cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/mcp-use/mcp-use/tree/main/skills/chatgpt-app-builder
...
**Input mẫu:**
```text
Objective: Chatgpt App Builder cho ứng dụng quản lý công việc
...
## Summary
- Goal: Chatgpt App Builder cho ứng dụng quản lý công việc
