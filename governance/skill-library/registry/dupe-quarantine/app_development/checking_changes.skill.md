...
- Cần Checking Change với tiêu chí rõ ràng
...
- UAT Record: [checking_changes](../../../governance/skill-library/uat/results/UAT-checking_changes.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Checking Change cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/streamlit/streamlit/tree/develop/.claude/skills/checking-changes
...
**Input mẫu:**
```text
Objective: Checking Change cho ứng dụng quản lý công việc
...
## Summary
- Goal: Checking Change cho ứng dụng quản lý công việc
