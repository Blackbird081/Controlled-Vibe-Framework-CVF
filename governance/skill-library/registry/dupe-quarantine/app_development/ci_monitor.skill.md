...
- Cần Ci Monitor với tiêu chí rõ ràng
...
- UAT Record: [ci_monitor](../../../governance/skill-library/uat/results/UAT-ci_monitor.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Ci Monitor cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/nrwl/nx/tree/master/.cursor/skills/ci-monitor
...
**Input mẫu:**
```text
Objective: Ci Monitor cho ứng dụng quản lý công việc
...
## Summary
- Goal: Ci Monitor cho ứng dụng quản lý công việc
