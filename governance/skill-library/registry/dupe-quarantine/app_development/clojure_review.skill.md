...
- Cần Clojure Review với tiêu chí rõ ràng
...
- UAT Record: [clojure_review](../../../governance/skill-library/uat/results/UAT-clojure_review.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Clojure Review cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/metabase/metabase/tree/master/.claude/skills/clojure-review
...
**Input mẫu:**
```text
Objective: Clojure Review cho ứng dụng quản lý công việc
...
## Summary
- Goal: Clojure Review cho ứng dụng quản lý công việc
