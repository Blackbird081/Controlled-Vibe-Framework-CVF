...
- Cần Cn Check với tiêu chí rõ ràng
...
- UAT Record: [cn_check](../../../governance/skill-library/uat/results/UAT-cn_check.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Cn Check cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/continuedev/continue/tree/main/skills/cn-check
...
**Input mẫu:**
```text
Objective: Cn Check cho ứng dụng quản lý công việc
...
## Summary
- Goal: Cn Check cho ứng dụng quản lý công việc
