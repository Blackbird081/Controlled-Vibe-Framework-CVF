...
- Cần Convex Backend với tiêu chí rõ ràng
...
- UAT Record: [convex_backend](../../../governance/skill-library/uat/results/UAT-convex_backend.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Convex Backend cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/CloudAI-X/claude-workflow-v2/tree/main/skills/convex-backend
