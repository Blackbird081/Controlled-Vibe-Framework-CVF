...
- Cần Create Migration với tiêu chí rõ ràng
...
- UAT Record: [create_migration](../../../governance/skill-library/uat/results/UAT-create_migration.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Create Migration cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/owid/owid-grapher/tree/master/.claude/skills/create-migration
