...
- Cần Db Migration And Chema Change với tiêu chí rõ ràng
...
- UAT Record: [db_migrations_and_schema_changes](../../../governance/skill-library/uat/results/UAT-db_migrations_and_schema_changes.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Db Migration And Chema Change cho sản phẩm SaaS nhỏ" |
...
```markdown
# Db Migration And Chema Change Output
...
- Nguồn tham khảo: https://github.com/letta-ai/letta/tree/main/.skills/db-migrations-schema-changes
...
**Input mẫu:**
```text
Objective: Db Migration And Chema Change cho ứng dụng quản lý công việc
...
## Summary
- Goal: Db Migration And Chema Change cho ứng dụng quản lý công việc
