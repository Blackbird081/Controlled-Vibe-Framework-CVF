...
- UAT Record: [dsql](../../../governance/skill-library/uat/results/UAT-dsql.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "D Ql cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/awslabs/mcp/tree/main/src/aurora-dsql-mcp-server/skills/dsql-skill
...
**Input mẫu:**
```text
Objective: D Ql cho ứng dụng quản lý công việc
...
## Summary
- Goal: D Ql cho ứng dụng quản lý công việc
