...
- Cần Engineering Tandard với tiêu chí rõ ràng
...
- UAT Record: [engineering_standards](../../../governance/skill-library/uat/results/UAT-engineering_standards.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Engineering Tandard cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/groupzer0/vs-code-agents/tree/main/vs-code-agents/skills/engineering-standards
