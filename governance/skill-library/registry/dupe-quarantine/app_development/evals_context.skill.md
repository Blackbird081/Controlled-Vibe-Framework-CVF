...
- Cần Eval Context với tiêu chí rõ ràng
...
- UAT Record: [evals_context](../../../governance/skill-library/uat/results/UAT-evals_context.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Eval Context cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/RooCodeInc/Roo-Code/tree/main/.roo/skills/evals-context
...
**Input mẫu:**
```text
Objective: Eval Context cho ứng dụng quản lý công việc
...
## Summary
- Goal: Eval Context cho ứng dụng quản lý công việc
