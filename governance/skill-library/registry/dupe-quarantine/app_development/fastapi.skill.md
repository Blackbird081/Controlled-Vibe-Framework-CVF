...
- Cần Fa Tapi với tiêu chí rõ ràng
...
- UAT Record: [fastapi](../../../governance/skill-library/uat/results/UAT-fastapi.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Fa Tapi cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/srbhr/Resume-Matcher/tree/main/.agent/skills/fastapi
...
**Input mẫu:**
```text
Objective: Fa Tapi cho ứng dụng quản lý công việc
...
## Summary
- Goal: Fa Tapi cho ứng dụng quản lý công việc
