...
- Cần Fetch Diff với tiêu chí rõ ràng
...
- UAT Record: [fetch_diff](../../../governance/skill-library/uat/results/UAT-fetch_diff.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Fetch Diff cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/mlflow/mlflow/tree/master/.claude/skills/fetch-diff
...
**Input mẫu:**
```text
Objective: Fetch Diff cho ứng dụng quản lý công việc
...
## Summary
- Goal: Fetch Diff cho ứng dụng quản lý công việc
