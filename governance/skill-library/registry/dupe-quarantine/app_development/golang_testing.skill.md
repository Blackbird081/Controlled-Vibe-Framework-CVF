...
- Cần Golang Te Ting với tiêu chí rõ ràng
...
- UAT Record: [golang_testing](../../../governance/skill-library/uat/results/UAT-golang_testing.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Golang Te Ting cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/affaan-m/everything-claude-code/tree/main/docs/zh-CN/skills/golang-testing
...
**Input mẫu:**
```text
Objective: Golang Te Ting cho ứng dụng quản lý công việc
...
## Summary
- Goal: Golang Te Ting cho ứng dụng quản lý công việc
