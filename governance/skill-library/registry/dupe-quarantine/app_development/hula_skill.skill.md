...
- Cần Hula Kill với tiêu chí rõ ràng
...
- UAT Record: [hula_skill](../../../governance/skill-library/uat/results/UAT-hula_skill.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Hula Kill cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/HuLaSpark/HuLa/tree/master/skills/hula-skill
...
**Input mẫu:**
```text
Objective: Hula Kill cho ứng dụng quản lý công việc
...
## Summary
- Goal: Hula Kill cho ứng dụng quản lý công việc
