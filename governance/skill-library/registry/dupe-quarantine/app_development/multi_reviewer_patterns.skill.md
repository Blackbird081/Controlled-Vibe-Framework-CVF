...
- Cần Multi Reviewer Pattern với tiêu chí rõ ràng
...
- UAT Record: [multi_reviewer_patterns](../../../governance/skill-library/uat/results/UAT-multi_reviewer_patterns.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Multi Reviewer Pattern cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/wshobson/agents/tree/main/plugins/agent-teams/skills/multi-reviewer-patterns
...
**Input mẫu:**
```text
Objective: Multi Reviewer Pattern cho ứng dụng quản lý công việc
...
## Summary
- Goal: Multi Reviewer Pattern cho ứng dụng quản lý công việc
