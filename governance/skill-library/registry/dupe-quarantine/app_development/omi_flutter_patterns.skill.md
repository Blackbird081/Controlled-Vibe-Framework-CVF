...
- Cần Omi Flutter Pattern với tiêu chí rõ ràng
...
- UAT Record: [omi_flutter_patterns](../../../governance/skill-library/uat/results/UAT-omi_flutter_patterns.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Omi Flutter Pattern cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/BasedHardware/omi/tree/main/.cursor/skills/omi-flutter-patterns
...
**Input mẫu:**
```text
Objective: Omi Flutter Pattern cho ứng dụng quản lý công việc
...
## Summary
- Goal: Omi Flutter Pattern cho ứng dụng quản lý công việc
