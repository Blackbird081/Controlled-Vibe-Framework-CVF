...
- Cần Opik Backend với tiêu chí rõ ràng
...
- UAT Record: [opik_backend](../../../governance/skill-library/uat/results/UAT-opik_backend.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Opik Backend cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/comet-ml/opik/tree/main/.agents/skills/opik-backend
...
**Input mẫu:**
```text
Objective: Opik Backend cho ứng dụng quản lý công việc
...
## Summary
- Goal: Opik Backend cho ứng dụng quản lý công việc
