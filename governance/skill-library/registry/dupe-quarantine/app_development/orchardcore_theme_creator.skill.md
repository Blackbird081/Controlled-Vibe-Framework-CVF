...
- Cần Orchardcore Theme Creator với tiêu chí rõ ràng
...
- UAT Record: [orchardcore_theme_creator](../../../governance/skill-library/uat/results/UAT-orchardcore_theme_creator.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Orchardcore Theme Creator cho sản phẩm SaaS nhỏ" |
...
```markdown
# Orchardcore Theme Creator Output
...
- Nguồn tham khảo: https://github.com/OrchardCMS/OrchardCore/tree/main/.agents/skills/orchardcore-theme-creator
...
**Input mẫu:**
```text
Objective: Orchardcore Theme Creator cho ứng dụng quản lý công việc
...
## Summary
- Goal: Orchardcore Theme Creator cho ứng dụng quản lý công việc
