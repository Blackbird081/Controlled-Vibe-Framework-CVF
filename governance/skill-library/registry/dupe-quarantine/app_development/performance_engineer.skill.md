...
- Cần Performance Engineer với tiêu chí rõ ràng
...
- UAT Record: [performance_engineer](../../../governance/skill-library/uat/results/UAT-performance_engineer.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Performance Engineer cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/performance-engineer
...
**Input mẫu:**
```text
Objective: Performance Engineer cho ứng dụng quản lý công việc
...
## Summary
- Goal: Performance Engineer cho ứng dụng quản lý công việc
