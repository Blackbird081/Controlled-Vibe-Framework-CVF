...
- Cần Playwright Cli với tiêu chí rõ ràng
...
- UAT Record: [playwright_cli](../../../governance/skill-library/uat/results/UAT-playwright_cli.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Playwright Cli cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/microsoft/playwright/tree/main/packages/playwright/src/skill
...
**Input mẫu:**
```text
Objective: Playwright Cli cho ứng dụng quản lý công việc
...
## Summary
- Goal: Playwright Cli cho ứng dụng quản lý công việc
