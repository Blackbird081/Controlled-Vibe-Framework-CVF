...
- Cần Project Navigation với tiêu chí rõ ràng
...
- UAT Record: [project_navigation](../../../governance/skill-library/uat/results/UAT-project_navigation.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Project Navigation cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/netalertx/NetAlertX/tree/main/.gemini/skills/project-navigation
...
**Input mẫu:**
```text
Objective: Project Navigation cho ứng dụng quản lý công việc
...
## Summary
- Goal: Project Navigation cho ứng dụng quản lý công việc
