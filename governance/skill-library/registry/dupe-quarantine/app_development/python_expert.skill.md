...
- Cần Python Expert với tiêu chí rõ ràng
...
- UAT Record: [python_expert](../../../governance/skill-library/uat/results/UAT-python_expert.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Python Expert cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/Shubhamsaboo/awesome-llm-apps/tree/main/awesome_agent_skills/python-expert
...
**Input mẫu:**
```text
Objective: Python Expert cho ứng dụng quản lý công việc
...
## Summary
- Goal: Python Expert cho ứng dụng quản lý công việc
