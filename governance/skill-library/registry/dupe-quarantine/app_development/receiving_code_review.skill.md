...
- Cần Receiving Code Review với tiêu chí rõ ràng
...
- UAT Record: [receiving_code_review](../../../governance/skill-library/uat/results/UAT-receiving_code_review.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Receiving Code Review cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/obra/superpowers/tree/main/skills/receiving-code-review
...
**Input mẫu:**
```text
Objective: Receiving Code Review cho ứng dụng quản lý công việc
...
## Summary
- Goal: Receiving Code Review cho ứng dụng quản lý công việc
