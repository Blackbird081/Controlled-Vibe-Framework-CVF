...
- Cần Ru T Backend với tiêu chí rõ ràng
...
- UAT Record: [rust_backend](../../../governance/skill-library/uat/results/UAT-rust_backend.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Ru T Backend cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/windmill-labs/windmill/tree/main/.claude/skills/rust-backend
...
**Input mẫu:**
```text
Objective: Ru T Backend cho ứng dụng quản lý công việc
...
## Summary
- Goal: Ru T Backend cho ứng dụng quản lý công việc
