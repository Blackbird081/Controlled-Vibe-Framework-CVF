...
- Cần Creen Hot Analyzer với tiêu chí rõ ràng
...
- UAT Record: [screenshot_analyzer](../../../governance/skill-library/uat/results/UAT-screenshot_analyzer.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Creen Hot Analyzer cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/notedit/happy-skills/tree/main/skills/screenshot-analyzer
