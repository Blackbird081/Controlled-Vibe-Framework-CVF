...
- Cần Tamagui với tiêu chí rõ ràng
...
- UAT Record: [tamagui](../../../governance/skill-library/uat/results/UAT-tamagui.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Tamagui cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/tamagui/tamagui/tree/main/plans/tamagui-skill/skills/tamagui
...
**Input mẫu:**
```text
Objective: Tamagui cho ứng dụng quản lý công việc
...
## Summary
- Goal: Tamagui cho ứng dụng quản lý công việc
