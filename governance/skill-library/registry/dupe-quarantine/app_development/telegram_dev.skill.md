...
- Cần Telegram Dev với tiêu chí rõ ràng
...
- UAT Record: [telegram_dev](../../../governance/skill-library/uat/results/UAT-telegram_dev.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Telegram Dev cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/2025Emma/vibe-coding-cn/tree/main/i18n/zh/skills/telegram-dev
...
**Input mẫu:**
```text
Objective: Telegram Dev cho ứng dụng quản lý công việc
...
## Summary
- Goal: Telegram Dev cho ứng dụng quản lý công việc
