...
- Cần Te Ting với tiêu chí rõ ràng
...
- UAT Record: [testing](../../../governance/skill-library/uat/results/UAT-testing.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Te Ting cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/LedgerHQ/ledger-live/tree/develop/.cursor/skills/testing
