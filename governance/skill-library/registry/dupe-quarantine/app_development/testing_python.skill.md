...
- Cần Te Ting Python với tiêu chí rõ ràng
...
- UAT Record: [testing_python](../../../governance/skill-library/uat/results/UAT-testing_python.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Te Ting Python cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/jlowin/fastmcp/tree/main/.claude/skills/python-tests
...
**Input mẫu:**
```text
Objective: Te Ting Python cho ứng dụng quản lý công việc
...
## Summary
- Goal: Te Ting Python cho ứng dụng quản lý công việc
