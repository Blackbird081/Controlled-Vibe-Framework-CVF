...
- Cần Validate With Databa E với tiêu chí rõ ràng
...
- UAT Record: [validate_with_database](../../../governance/skill-library/uat/results/UAT-validate_with_database.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Validate With Databa E cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/pgschema/pgschema/tree/main/.claude/skills/validate_db
