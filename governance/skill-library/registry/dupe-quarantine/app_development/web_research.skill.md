...
- Cần Web Re Earch với tiêu chí rõ ràng
...
- UAT Record: [web_research](../../../governance/skill-library/uat/results/UAT-web_research.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Web Re Earch cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/langchain-ai/deepagents/tree/master/libs/cli/examples/skills/web-research
...
**Input mẫu:**
```text
Objective: Web Re Earch cho ứng dụng quản lý công việc
...
## Summary
- Goal: Web Re Earch cho ứng dụng quản lý công việc
