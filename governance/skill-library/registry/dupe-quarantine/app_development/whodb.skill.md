...
- Cần Whodb với tiêu chí rõ ràng
...
- UAT Record: [whodb](../../../governance/skill-library/uat/results/UAT-whodb.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Whodb cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/clidey/whodb/tree/main/cli/external-plugin/whodb/skills/whodb
