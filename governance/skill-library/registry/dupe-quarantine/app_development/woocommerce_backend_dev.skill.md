...
- Cần Woocommerce Backend Dev với tiêu chí rõ ràng
...
- UAT Record: [woocommerce_backend_dev](../../../governance/skill-library/uat/results/UAT-woocommerce_backend_dev.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Woocommerce Backend Dev cho sản phẩm SaaS nhỏ" |
...
```markdown
# Woocommerce Backend Dev Output
...
- Nguồn tham khảo: https://github.com/woocommerce/woocommerce/tree/trunk/.ai/skills/woocommerce-backend-dev
...
**Input mẫu:**
```text
Objective: Woocommerce Backend Dev cho ứng dụng quản lý công việc
...
## Summary
- Goal: Woocommerce Backend Dev cho ứng dụng quản lý công việc
