...
- Cần Knowledge Capture với tiêu chí rõ ràng
...
- UAT Record: [knowledge_capture](../../../governance/skill-library/uat/results/UAT-knowledge_capture.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Knowledge Capture cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/rsmdt/the-startup/tree/main/plugins/start/skills/knowledge-capture
