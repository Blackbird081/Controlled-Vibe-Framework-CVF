...
- Cần Ri K Analy I với tiêu chí rõ ràng
...
- UAT Record: [risk_analysis](../../../governance/skill-library/uat/results/UAT-risk_analysis.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Ri K Analy I cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/Prorise-cool/Claude-Code-Multi-Agent/tree/master/.claude/skills/business-analysis/risk-analysis
