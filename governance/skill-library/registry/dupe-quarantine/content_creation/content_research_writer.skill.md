...
- Keyword focus: content writing
- Nguồn tham khảo: https://github.com/davepoon/buildwithclaude/tree/main/plugins/all-skills/skills/content-research-writer
...
## Summary
- Goal: Xây dựng series blog onboarding cho SaaS
- Context: Sản phẩm B2B, tập trung chuyển đổi trial
- Constraints: Giữ brand voice hiện có

## Key Findings
1. Thông điệp giá trị chưa nhất quán
2. Thiếu call-to-action theo từng bài
3. Chưa có guideline tone/format thống nhất
