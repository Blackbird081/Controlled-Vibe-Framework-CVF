...
- Cần Write Relea E Note với tiêu chí rõ ràng
...
- UAT Record: [write_release_notes](../../../governance/skill-library/uat/results/UAT-write_release_notes.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Write Relea E Note cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/tldraw/tldraw/tree/main/.claude/skills/write-release-notes
...
**Input mẫu:**
```text
Objective: Write Relea E Note cho ứng dụng quản lý công việc
...
## Summary
- Goal: Write Relea E Note cho ứng dụng quản lý công việc
