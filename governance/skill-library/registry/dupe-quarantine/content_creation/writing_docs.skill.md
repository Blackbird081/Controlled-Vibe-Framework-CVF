...
- Cần Writing Doc với tiêu chí rõ ràng
...
- UAT Record: [writing_docs](../../../governance/skill-library/uat/results/UAT-writing_docs.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Writing Doc cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/remotion-dev/remotion/tree/main/.claude/skills/writing-docs
...
**Input mẫu:**
```text
Objective: Writing Doc cho ứng dụng quản lý công việc
...
## Summary
- Goal: Writing Doc cho ứng dụng quản lý công việc
