...
- Cần Writing Kill với tiêu chí rõ ràng
...
- UAT Record: [writing_skill](../../../governance/skill-library/uat/results/UAT-writing_skill.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Writing Kill cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/agentscope-ai/agentscope-java/tree/main/agentscope-core/src/test/resources/test-skills/writing-skill
...
**Input mẫu:**
```text
Objective: Writing Kill cho ứng dụng quản lý công việc
...
## Summary
- Goal: Writing Kill cho ứng dụng quản lý công việc
