...
- Cần It Role Expert với tiêu chí rõ ràng
...
- UAT Record: [it_role_expert](../../../governance/skill-library/uat/results/UAT-it_role_expert.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "It Role Expert cho sản phẩm SaaS nhỏ" |
...
- Keyword focus: hr operations
- Nguồn tham khảo: https://github.com/krafton-ai/KIRA/tree/main/.claude/skills/it-role-expert
...
## Summary
- Goal: Viết JD cho vị trí Product Manager
- Context: Công ty scale nhanh, team 10 người
- Constraints: Ưu tiên ứng viên có background SaaS

## Key Findings
1. Tiêu chí đầu vào chưa đo lường được
2. Thiếu mô tả trách nhiệm theo KPI
3. Chưa nêu rõ lộ trình phát triển
