...
- Cần Bocha Earch với tiêu chí rõ ràng
...
- UAT Record: [bocha_search](../../../governance/skill-library/uat/results/UAT-bocha_search.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Bocha Earch cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/zhayujie/chatgpt-on-wechat/tree/master/skills/bocha-search
...
**Input mẫu:**
```text
Objective: Bocha Earch cho ứng dụng quản lý công việc
...
## Summary
- Goal: Bocha Earch cho ứng dụng quản lý công việc
