...
- Cần Btca Cli với tiêu chí rõ ràng
...
- UAT Record: [btca_cli](../../../governance/skill-library/uat/results/UAT-btca_cli.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Btca Cli cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/davis7dotsh/better-context/tree/main/skills/btca-cli
...
**Input mẫu:**
```text
Objective: Btca Cli cho ứng dụng quản lý công việc
...
## Summary
- Goal: Btca Cli cho ứng dụng quản lý công việc
