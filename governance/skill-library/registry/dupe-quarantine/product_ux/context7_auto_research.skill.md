...
- Cần Context7 Auto Re Earch với tiêu chí rõ ràng
...
- UAT Record: [context7_auto_research](../../../governance/skill-library/uat/results/UAT-context7_auto_research.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Context7 Auto Re Earch cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/freekmurze/dotfiles/tree/main/config/claude/skills/context7-auto-research
...
**Input mẫu:**
```text
Objective: Context7 Auto Re Earch cho ứng dụng quản lý công việc
...
## Summary
- Goal: Context7 Auto Re Earch cho ứng dụng quản lý công việc
