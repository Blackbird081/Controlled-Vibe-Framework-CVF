...
- Cần De Igning Experiment với tiêu chí rõ ràng
...
- UAT Record: [designing_experiments](../../../governance/skill-library/uat/results/UAT-designing_experiments.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "De Igning Experiment cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/pymc-labs/CausalPy/tree/main/.claude/skills/designing-experiments
...
**Input mẫu:**
```text
Objective: De Igning Experiment cho ứng dụng quản lý công việc
...
## Summary
- Goal: De Igning Experiment cho ứng dụng quản lý công việc
