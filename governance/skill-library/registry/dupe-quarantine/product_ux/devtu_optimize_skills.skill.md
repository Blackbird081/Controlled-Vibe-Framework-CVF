...
- Cần Devtu Optimize Kill với tiêu chí rõ ràng
...
- UAT Record: [devtu_optimize_skills](../../../governance/skill-library/uat/results/UAT-devtu_optimize_skills.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Devtu Optimize Kill cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/mims-harvard/ToolUniverse/tree/main/skills/devtu-optimize-skills
...
**Input mẫu:**
```text
Objective: Devtu Optimize Kill cho ứng dụng quản lý công việc
...
## Summary
- Goal: Devtu Optimize Kill cho ứng dụng quản lý công việc
