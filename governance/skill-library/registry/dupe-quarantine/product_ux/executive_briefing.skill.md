...
- Cần Executive Briefing với tiêu chí rõ ràng
...
- UAT Record: [executive_briefing](../../../governance/skill-library/uat/results/UAT-executive_briefing.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Executive Briefing cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/anthropics/claude-agent-sdk-demos/tree/main/research-agent/.claude/skills/executive-briefing
...
**Input mẫu:**
```text
Objective: Executive Briefing cho ứng dụng quản lý công việc
...
## Summary
- Goal: Executive Briefing cho ứng dụng quản lý công việc
