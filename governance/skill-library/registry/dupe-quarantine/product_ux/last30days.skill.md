...
- Cần La T30day với tiêu chí rõ ràng
...
- UAT Record: [last30days](../../../governance/skill-library/uat/results/UAT-last30days.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "La T30day cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/mvanhorn/last30days-skill
...
**Input mẫu:**
```text
Objective: La T30day cho ứng dụng quản lý công việc
...
## Summary
- Goal: La T30day cho ứng dụng quản lý công việc
