...
- Cần Planning With File với tiêu chí rõ ràng
...
- UAT Record: [planning_with_files](../../../governance/skill-library/uat/results/UAT-planning_with_files.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Planning With File cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/jarrodwatts/claude-code-config/tree/main/skills/planning-with-files
...
**Input mẫu:**
```text
Objective: Planning With File cho ứng dụng quản lý công việc
...
## Summary
- Goal: Planning With File cho ứng dụng quản lý công việc
