...
- Cần Pptx Po Ter với tiêu chí rõ ràng
...
- UAT Record: [pptx_posters](../../../governance/skill-library/uat/results/UAT-pptx_posters.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Pptx Po Ter cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/K-Dense-AI/claude-scientific-writer/tree/main/scientific_writer/.claude/skills/pptx-posters
...
**Input mẫu:**
```text
Objective: Pptx Po Ter cho ứng dụng quản lý công việc
...
## Summary
- Goal: Pptx Po Ter cho ứng dụng quản lý công việc
