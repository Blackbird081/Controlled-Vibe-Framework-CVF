...
- Cần Vibe Re Earch với tiêu chí rõ ràng
...
- UAT Record: [vibe_research](../../../governance/skill-library/uat/results/UAT-vibe_research.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Vibe Re Earch cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/KhazP/vibe-coding-prompt-template/tree/main/.claude/skills/vibe-research
...
**Input mẫu:**
```text
Objective: Vibe Re Earch cho ứng dụng quản lý công việc
...
## Summary
- Goal: Vibe Re Earch cho ứng dụng quản lý công việc
