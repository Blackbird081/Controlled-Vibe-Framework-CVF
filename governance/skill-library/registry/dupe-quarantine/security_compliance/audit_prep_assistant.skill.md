...
- Cần Audit Prep A I Tant với tiêu chí rõ ràng
...
- UAT Record: [audit_prep_assistant](../../../governance/skill-library/uat/results/UAT-audit_prep_assistant.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Audit Prep A I Tant cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/trailofbits/skills/tree/main/plugins/building-secure-contracts/skills/audit-prep-assistant
...
**Input mẫu:**
```text
Objective: Audit Prep A I Tant cho ứng dụng quản lý công việc
...
## Summary
- Goal: Audit Prep A I Tant cho ứng dụng quản lý công việc
