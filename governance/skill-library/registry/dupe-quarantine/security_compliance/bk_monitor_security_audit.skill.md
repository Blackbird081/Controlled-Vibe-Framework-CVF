...
- Cần Bk Monitor Ecurity Audit với tiêu chí rõ ràng
...
- UAT Record: [bk_monitor_security_audit](../../../governance/skill-library/uat/results/UAT-bk_monitor_security_audit.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Bk Monitor Ecurity Audit cho sản phẩm SaaS nhỏ" |
...
```markdown
# Bk Monitor Ecurity Audit Output
...
- Nguồn tham khảo: https://github.com/TencentBlueKing/bk-bcs/tree/master/bcs-services/bcs-project-manager/.cursor/skills/bk-monitor-security-audit
...
**Input mẫu:**
```text
Objective: Bk Monitor Ecurity Audit cho ứng dụng quản lý công việc
...
## Summary
- Goal: Bk Monitor Ecurity Audit cho ứng dụng quản lý công việc
...
- [Audit Prep A I Tant](./audit_prep_assistant.skill.md)
