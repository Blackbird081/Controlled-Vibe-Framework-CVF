...
- Cần K8 Ecurity với tiêu chí rõ ràng
...
- UAT Record: [k8s_security](../../../governance/skill-library/uat/results/UAT-k8s_security.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "K8 Ecurity cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/rohitg00/kubectl-mcp-server/tree/main/kubernetes-skills/claude/k8s-security
...
**Input mẫu:**
```text
Objective: K8 Ecurity cho ứng dụng quản lý công việc
...
## Summary
- Goal: K8 Ecurity cho ứng dụng quản lý công việc
