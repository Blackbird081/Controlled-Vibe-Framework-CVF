...
- Cần Relea E với tiêu chí rõ ràng
...
- UAT Record: [release](../../../governance/skill-library/uat/results/UAT-release.md)
...
|-------|-------|:--------:|-------|
| **Objective** | Mục tiêu chính | ✅ | "Relea E cho sản phẩm SaaS nhỏ" |
...
- Nguồn tham khảo: https://github.com/parcadei/Continuous-Claude-v3/tree/main/.claude/skills/release
...
**Input mẫu:**
```text
Objective: Relea E cho ứng dụng quản lý công việc
...
## Summary
- Goal: Relea E cho ứng dụng quản lý công việc
