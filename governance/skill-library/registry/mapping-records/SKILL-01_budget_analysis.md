# SKILL MAPPING RECORD — Budget Analysis

> **Skill ID:** 01_budget_analysis  
...
### 2.1 Core Capability
Budget Analysis theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
