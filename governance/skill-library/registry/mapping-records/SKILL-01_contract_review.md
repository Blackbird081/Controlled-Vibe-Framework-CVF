# SKILL MAPPING RECORD — Contract Review

> **Skill ID:** 01_contract_review  
...
### 2.1 Core Capability
Contract Review theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Loại hợp đồng, Nội dung hợp đồng, Vai trò của bạn, Mục đích chính, Industry context
