# SKILL MAPPING RECORD — Documentation

> **Skill ID:** 01_documentation  
...
### 2.1 Core Capability
Documentation theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Loại docs, Đối tượng, Phạm vi, Tone, Existing docs
