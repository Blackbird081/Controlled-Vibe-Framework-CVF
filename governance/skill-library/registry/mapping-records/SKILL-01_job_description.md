# SKILL MAPPING RECORD — Job Description

> **Skill ID:** 01_job_description  
...
### 2.1 Core Capability
Job Description theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Vị trí, Level, Department, Responsibilities, Requirements, Benefits, Salary range
