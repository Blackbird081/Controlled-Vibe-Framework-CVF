# SKILL MAPPING RECORD — Landing Page

> **Skill ID:** 01_landing_page  
...
### 2.1 Core Capability
Landing Page theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Sản phẩm, Mục tiêu, Đối tượng, Brand, Tham khảo, Đặc biệt
