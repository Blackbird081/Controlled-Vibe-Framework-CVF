# SKILL MAPPING RECORD — Model Selection

> **Skill ID:** 01_model_selection  
...
### 2.1 Core Capability
Model Selection theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Use case, Volume, Budget, Quality needs, Latency
