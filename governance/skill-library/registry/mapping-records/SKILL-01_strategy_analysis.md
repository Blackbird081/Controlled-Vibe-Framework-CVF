# SKILL MAPPING RECORD — Strategy Analysis

> **Skill ID:** 01_strategy_analysis  
...
### 2.1 Core Capability
Strategy Analysis theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Tình huống, Các phương án, Mục tiêu, Ràng buộc, Context ngành
