# SKILL MAPPING RECORD — Vibe-to-Spec Translator
...
- Skill ID: 01_vibe_to_spec
- Skill Name: Vibe-to-Spec Translator
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
Vibe-to-Spec Translator theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Vibe Description, App Type, Target Users
