# SKILL MAPPING RECORD — Architecture Review

> **Skill ID:** 02_architecture_review  
...
### 2.1 Core Capability
Architecture Review theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Architecture, Requirements, Constraints, Scale, Concerns
