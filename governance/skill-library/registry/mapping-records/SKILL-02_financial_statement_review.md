# SKILL MAPPING RECORD — Financial Statement Review

> **Skill ID:** 02_financial_statement_review  
...
- Skill ID: 02_financial_statement_review
- Skill Name: Financial Statement Review
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
Financial Statement Review theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Objective, Context, Constraints
