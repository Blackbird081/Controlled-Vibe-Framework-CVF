# SKILL MAPPING RECORD — Interview Evaluation

> **Skill ID:** 02_interview_evaluation  
...
- Skill ID: 02_interview_evaluation
- Skill Name: Interview Evaluation
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
Interview Evaluation theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Tên ứng viên, Vị trí, Interview notes, Evaluation criteria, Interviewers, Red flags observed
...
Risk level R2 phù hợp với domain HR & Operations và được ràng buộc bởi governance summary.
