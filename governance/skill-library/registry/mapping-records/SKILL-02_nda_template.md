# SKILL MAPPING RECORD — NDA Template

> **Skill ID:** 02_nda_template  
...
### 2.1 Core Capability
NDA Template theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Disclosing Party, Receiving Party, Purpose, Type, Duration, Jurisdiction, Special terms
