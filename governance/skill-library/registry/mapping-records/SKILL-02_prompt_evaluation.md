# SKILL MAPPING RECORD — Prompt Evaluation

> **Skill ID:** 02_prompt_evaluation  
...
### 2.1 Core Capability
Prompt Evaluation theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Prompt, Expected output, Current issues, Model
