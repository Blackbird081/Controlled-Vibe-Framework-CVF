# SKILL MAPPING RECORD — Report Writing

> **Skill ID:** 02_report_writing  
...
### 2.1 Core Capability
Report Writing theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Report type, Audience, Key data, Time period, Key questions, Format preference
