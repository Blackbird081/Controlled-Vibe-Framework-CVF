# SKILL MAPPING RECORD — Risk Assessment

> **Skill ID:** 02_risk_assessment  
...
### 2.1 Core Capability
Risk Assessment theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Quyết định/Dự án, Stakeholders, Timeline, Investment, Known concerns, Risk tolerance
