# SKILL MAPPING RECORD — SaaS App

> **Skill ID:** 02_saas_app  
...
### 2.1 Core Capability
SaaS App theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Tên app, Core features, User roles, Đối tượng, Auth method, Payment, Tham khảo
