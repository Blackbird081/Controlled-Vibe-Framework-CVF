# SKILL MAPPING RECORD — Tech Stack Selection

> **Skill ID:** 02_tech_stack_selection  
...
- Skill ID: 02_tech_stack_selection
- Skill Name: Tech Stack Selection
- Version: 1.1.1
- Source:
...
### 2.1 Core Capability
Tech Stack Selection theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: App Type, Primary Language Preference, Performance Priority, Development Speed Priority, Team Experience, Platform Targets, Data Storage Needs, Offline Required, Bundle Size Constraint, Existing Codebase
...
Risk level R1 phù hợp với domain App Development và được ràng buộc bởi governance summary.
