# SKILL MAPPING RECORD — Vibe Logic Mapping

> **Skill ID:** 02_vibe_logic_mapping  
...
### 2.1 Core Capability
Vibe Logic Mapping theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Vibe đã duyệt, Tech Stack, App Type
