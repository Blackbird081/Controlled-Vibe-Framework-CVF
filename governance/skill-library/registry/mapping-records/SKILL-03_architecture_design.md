# SKILL MAPPING RECORD — Architecture Design

> **Skill ID:** 03_architecture_design  
...
### 2.1 Core Capability
Architecture Design theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: App Name, Tech Stack, Core Features, App Type, Data Flow, External Integrations, State Management, Security Requirements
