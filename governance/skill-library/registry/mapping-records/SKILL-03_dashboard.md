# SKILL MAPPING RECORD — Dashboard

> **Skill ID:** 03_dashboard  
...
### 2.1 Core Capability
Dashboard theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Mục đích, Data chính, KPIs, Người dùng, Actions, Dark mode
