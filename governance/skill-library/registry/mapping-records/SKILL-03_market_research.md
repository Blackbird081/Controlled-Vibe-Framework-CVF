# SKILL MAPPING RECORD — Market Research

> **Skill ID:** 03_market_research  
...
### 2.1 Core Capability
Market Research theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Market focus, Research goal, Scope, Products/Services, Known players, Data sources preferred
