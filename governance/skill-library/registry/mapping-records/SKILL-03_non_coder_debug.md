# SKILL MAPPING RECORD — Non-coder Debug

> **Skill ID:** 03_non_coder_debug  
...
### 2.1 Core Capability
Non-coder Debug theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Mô tả hiện tượng, Bước tái hiện, Lỗi xuất hiện lần đầu khi
