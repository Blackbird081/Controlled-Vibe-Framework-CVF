# SKILL MAPPING RECORD — Output Quality Check

> **Skill ID:** 03_output_quality_check  
...
- Skill ID: 03_output_quality_check
- Skill Name: Output Quality Check
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
Output Quality Check theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: AI Output, Requirements, Context, Quality criteria
