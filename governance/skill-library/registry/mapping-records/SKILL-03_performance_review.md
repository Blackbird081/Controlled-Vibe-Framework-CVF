# SKILL MAPPING RECORD — Performance Review

> **Skill ID:** 03_performance_review  
...
### 2.1 Core Capability
Performance Review theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Tên nhân viên, Vị trí, Review period, Goals/OKRs, Achievements, Areas for improvement, Peer feedback
