# SKILL MAPPING RECORD — Presentation

> **Skill ID:** 03_presentation  
...
### 2.1 Core Capability
Presentation theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Presentation type, Audience, Goal, Time limit, Key message, Main points
