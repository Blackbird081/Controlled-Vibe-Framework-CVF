# SKILL MAPPING RECORD — ROI Calculator Review

> **Skill ID:** 03_roi_calculator_review  
...
- Skill ID: 03_roi_calculator_review
- Skill Name: ROI Calculator Review
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
ROI Calculator Review theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
