# SKILL MAPPING RECORD — Security Audit

> **Skill ID:** 03_security_audit  
...
### 2.1 Core Capability
Security Audit theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: System description, Tech stack, Data handled, Current measures, Compliance needs, Threat model
...
Risk level R1 phù hợp với domain Technical Review và được ràng buộc bởi governance summary.
