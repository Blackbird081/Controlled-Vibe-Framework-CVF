# SKILL MAPPING RECORD — Terms of Service

> **Skill ID:** 03_terms_of_service  
...
### 2.1 Core Capability
Terms of Service theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Company name, Product/Service, Target users, Key features, Pricing model, Data handling, Jurisdictions
