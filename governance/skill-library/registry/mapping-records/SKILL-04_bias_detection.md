# SKILL MAPPING RECORD — Bias Detection

> **Skill ID:** 04_bias_detection  
...
### 2.1 Core Capability
Bias Detection theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: AI Application, Sample outputs, Protected classes, Decision impact
