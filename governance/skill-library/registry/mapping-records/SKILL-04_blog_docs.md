# SKILL MAPPING RECORD — Blog / Documentation

> **Skill ID:** 04_blog_docs  
...
### 2.1 Core Capability
Blog / Documentation theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Loại, Nội dung, Tần suất, Authors, Categories, Tham khảo
