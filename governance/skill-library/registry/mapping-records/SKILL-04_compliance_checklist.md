# SKILL MAPPING RECORD — Compliance Checklist

> **Skill ID:** 04_compliance_checklist  
...
- Skill ID: 04_compliance_checklist
- Skill Name: Compliance Checklist
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
Compliance Checklist theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Business type, Target markets, Data collected, Data storage
