# SKILL MAPPING RECORD — Database Schema Design

> **Skill ID:** 04_database_schema_design  
...
### 2.1 Core Capability
Database Schema Design theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: App Name, Database Type, Main Entities, Relationships, Key Fields per Entity, Search/Query Needs, Data Volume Expected, Audit Requirements
