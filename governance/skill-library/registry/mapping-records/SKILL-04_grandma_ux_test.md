# SKILL MAPPING RECORD — Grandma UX Test
...
### 2.1 Core Capability
Grandma UX Test theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Mô tả app, Tính năng chính, Screenshot/mô tả UI
