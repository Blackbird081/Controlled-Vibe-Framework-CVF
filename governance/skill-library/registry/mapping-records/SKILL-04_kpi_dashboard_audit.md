# SKILL MAPPING RECORD — KPI Dashboard Audit

> **Skill ID:** 04_kpi_dashboard_audit  
...
- Skill ID: 04_kpi_dashboard_audit
- Skill Name: KPI Dashboard Audit
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
KPI Dashboard Audit theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
