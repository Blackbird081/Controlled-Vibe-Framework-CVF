# SKILL MAPPING RECORD — Onboarding Checklist

> **Skill ID:** 04_onboarding_checklist  
...
### 2.1 Core Capability
Onboarding Checklist theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Tên nhân viên, Vị trí, Department, Start date, Manager, Work mode, Special needs
