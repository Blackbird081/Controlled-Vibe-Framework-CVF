# SKILL MAPPING RECORD — API Design Spec

> **Skill ID:** 05_api_design_spec  
...
### 2.1 Core Capability
API Design Spec theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: App Name, API Style, Resources/Entities, Operations per Entity, Auth Required, Response Format, Pagination Needed, Error Format
