# SKILL MAPPING RECORD — Auto Documentation (Vietnamese)

> **Skill ID:** 05_auto_documentation_vn  
...
- Skill ID: 05_auto_documentation_vn
- Skill Name: Auto Documentation (Vietnamese)
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
Auto Documentation (Vietnamese) theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Tên app, Cách khởi động, Tính năng chính, Hệ điều hành, Lỗi thường gặp
...
Risk level R1 phù hợp với domain Non-coder Workflow và được ràng buộc bởi governance summary.
