# SKILL MAPPING RECORD — Cash Flow Analysis

> **Skill ID:** 05_cash_flow_analysis  
...
### 2.1 Core Capability
Cash Flow Analysis theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
