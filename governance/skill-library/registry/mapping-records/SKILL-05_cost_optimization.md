# SKILL MAPPING RECORD — Cost Optimization

> **Skill ID:** 05_cost_optimization  
...
### 2.1 Core Capability
Cost Optimization theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Current usage, Current cost, Use case breakdown, Quality requirements
