# SKILL MAPPING RECORD — IP Protection

> **Skill ID:** 05_ip_protection  
...
### 2.1 Core Capability
IP Protection theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Company/Product, IP Assets, Business model, Team structure
