# SKILL MAPPING RECORD — Policy Documentation

> **Skill ID:** 05_policy_documentation  
...
- Skill ID: 05_policy_documentation
- Skill Name: Policy Documentation
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
Policy Documentation theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Policy topic, Purpose, Scope, Key rules, Exceptions, Effective date
