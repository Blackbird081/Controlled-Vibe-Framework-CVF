# SKILL MAPPING RECORD — AI Use Case Fit

> **Skill ID:** 06_ai_use_case_fit  
...
### 2.1 Core Capability
AI Use Case Fit theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Problem, Current solution, Volume, Quality bar, Budget
