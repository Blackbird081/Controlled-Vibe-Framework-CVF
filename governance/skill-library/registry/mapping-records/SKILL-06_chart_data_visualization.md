# SKILL MAPPING RECORD — Chart & Data Visualization

> **Skill ID:** 06_chart_data_visualization  
...
- Skill ID: 06_chart_data_visualization
- Skill Name: Chart & Data Visualization
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
Chart & Data Visualization theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Loại dữ liệu, Số data points, Mục đích, Framework, Interactive, Accessibility
...
Risk level R1 phù hợp với domain Web Development và được ràng buộc bởi governance summary.
