# SKILL MAPPING RECORD — Desktop App Spec

> **Skill ID:** 06_desktop_app_spec  
...
### 2.1 Core Capability
Desktop App Spec theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: App Name, Framework, Target Platforms, Window Type, Default Size, Menu Bar, System Tray, Keyboard Shortcuts, Native Features, Startup Behavior
