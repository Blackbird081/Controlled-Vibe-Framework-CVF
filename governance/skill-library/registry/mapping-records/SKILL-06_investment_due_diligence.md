# SKILL MAPPING RECORD — Investment Due Diligence

> **Skill ID:** 06_investment_due_diligence  
...
- Skill ID: 06_investment_due_diligence
- Skill Name: Investment Due Diligence
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
Investment Due Diligence theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
