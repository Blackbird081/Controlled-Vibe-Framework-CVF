# SKILL MAPPING RECORD — Portable App Packaging

> **Skill ID:** 06_portable_packaging  
...
- Skill ID: 06_portable_packaging
- Skill Name: Portable App Packaging
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
Portable App Packaging theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Tên app, Tech stack, Hệ điều hành người nhận, Có database không
