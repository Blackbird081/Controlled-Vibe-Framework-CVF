# SKILL MAPPING RECORD — CLI Tool Spec

> **Skill ID:** 07_cli_tool_spec  
...
### 2.1 Core Capability
CLI Tool Spec theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Tool Name, Purpose, Commands, Target Users, Language, Config Location, Data Storage, Shell Completion, Output Formats
