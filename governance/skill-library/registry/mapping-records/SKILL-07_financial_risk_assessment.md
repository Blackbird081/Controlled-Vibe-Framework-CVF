# SKILL MAPPING RECORD — Financial Risk Assessment

> **Skill ID:** 07_financial_risk_assessment  
...
- Skill ID: 07_financial_risk_assessment
- Skill Name: Financial Risk Assessment
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
Financial Risk Assessment theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
