# SKILL MAPPING RECORD — Landing Page Pattern

> **Skill ID:** 07_landing_page_pattern  
...
- Skill ID: 07_landing_page_pattern
- Skill Name: Landing Page Pattern
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
Landing Page Pattern theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Mục đích, Sản phẩm, Đối tượng, CTA mong muốn, Đã có content, Số sections ước
