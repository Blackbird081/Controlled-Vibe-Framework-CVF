# SKILL MAPPING RECORD — Project Init Checklist (Non-coder)

> **Skill ID:** 07_project_init_checklist  
...
- Skill ID: 07_project_init_checklist
- Skill Name: Project Init Checklist (Non-coder)
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
Project Init Checklist (Non-coder) theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Tên dự án, Mô tả 1 câu, Hệ điều hành, Python đã cài chưa
