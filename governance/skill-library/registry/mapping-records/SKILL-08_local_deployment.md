# SKILL MAPPING RECORD — Local Deployment Spec

> **Skill ID:** 08_local_deployment  
...
- Skill ID: 08_local_deployment
- Skill Name: Local Deployment Spec
- Version: 1.1.1
- Source:
...
### 2.1 Core Capability
Local Deployment Spec theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: App Name, App Type, Target Platforms, Distribution Method, Auto-Update, Signing Required, Install Location, Uninstaller, Dependencies
