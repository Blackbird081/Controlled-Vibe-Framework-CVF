# SKILL MAPPING RECORD — Revenue Forecast Review

> **Skill ID:** 08_revenue_forecast_review  
...
- Skill ID: 08_revenue_forecast_review
- Skill Name: Revenue Forecast Review
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
Revenue Forecast Review theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
