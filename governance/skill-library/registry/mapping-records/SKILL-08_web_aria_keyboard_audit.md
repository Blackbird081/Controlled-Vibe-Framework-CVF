# SKILL MAPPING RECORD — Web ARIA & Keyboard Audit

> **Skill ID:** 08_web_aria_keyboard_audit  
...
- Skill ID: 08_web_aria_keyboard_audit
- Skill Name: Web ARIA & Keyboard Audit
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
Web ARIA & Keyboard Audit theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: URL/Code, Components, Framework, Screen readers, Compliance
