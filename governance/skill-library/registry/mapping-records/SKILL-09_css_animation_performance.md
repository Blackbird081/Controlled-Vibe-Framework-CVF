# SKILL MAPPING RECORD — CSS Animation & Performance

> **Skill ID:** 09_css_animation_performance  
...
- Skill ID: 09_css_animation_performance
- Skill Name: CSS Animation & Performance
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
CSS Animation & Performance theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: URL/Code, Animation types, Framework, Performance goals, Devices
