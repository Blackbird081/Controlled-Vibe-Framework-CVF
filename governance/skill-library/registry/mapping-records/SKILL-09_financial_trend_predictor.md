# SKILL MAPPING RECORD — Financial Trend Predictor

> **Skill ID:** 09_financial_trend_predictor  
...
- Skill ID: 09_financial_trend_predictor
- Skill Name: Financial Trend Predictor
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
Financial Trend Predictor theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Loại dữ liệu, Số tháng lịch sử, Số tháng dự báo, Ngưỡng cảnh báo, Nguồn dữ liệu
...
Risk level R2 phù hợp với domain Finance & Analytics và được ràng buộc bởi governance summary.
