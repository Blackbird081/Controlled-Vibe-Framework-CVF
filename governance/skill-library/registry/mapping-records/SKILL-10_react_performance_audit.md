# SKILL MAPPING RECORD — React Performance Audit

> **Skill ID:** 10_react_performance_audit  
...
- Skill ID: 10_react_performance_audit
- Skill Name: React Performance Audit
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
React Performance Audit theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Code/Repo, Framework, Symptoms, Bundle size, Lighthouse, Key pages
