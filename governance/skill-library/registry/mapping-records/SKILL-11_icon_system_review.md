# SKILL MAPPING RECORD — Icon System Review

> **Skill ID:** 11_icon_system_review  
...
### 2.1 Core Capability
Icon System Review theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: URL/Code, Current icon source, Brand logos, Framework
