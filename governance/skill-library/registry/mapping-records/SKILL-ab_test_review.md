# SKILL MAPPING RECORD — A/B Test Review

> **Skill ID:** ab_test_review  
> **Domain:** Product & UX  
...
### 2.1 Core Capability
A/B Test Review theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Tên Test, Hypothesis, Metric chính (OKR), Control vs Variant, Sample Size, Duration, Results Data
