# SKILL MAPPING RECORD — Accessibility Audit (WCAG)

> **Skill ID:** accessibility_audit  
> **Domain:** Product & UX  
...
- Skill ID: accessibility_audit
- Skill Name: Accessibility Audit (WCAG)
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
Accessibility Audit (WCAG) theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: URL/App, Target WCAG Level, Key Pages, User Types, Industry, Current Issues
