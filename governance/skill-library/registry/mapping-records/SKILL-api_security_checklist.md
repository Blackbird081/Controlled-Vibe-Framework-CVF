# SKILL MAPPING RECORD — API Security Checklist

> **Skill ID:** api_security_checklist  
...
### 2.1 Core Capability
API Security Checklist theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: API Endpoints, Authentication Type, API Type, Data Sensitivity, Current Security Measures, Known Vulnerabilities
