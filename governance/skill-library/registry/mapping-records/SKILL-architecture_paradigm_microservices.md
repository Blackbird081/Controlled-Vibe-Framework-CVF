# SKILL MAPPING RECORD — Architecture Paradigm Micro Ervice

> **Skill ID:** architecture_paradigm_microservices  
...
- Skill ID: architecture_paradigm_microservices
- Skill Name: Architecture Paradigm Micro Ervice
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/athola/claude-night-market/tree/master/plugins/archetypes/skills/architecture-paradigm-microservices
...
### 2.1 Core Capability
Architecture Paradigm Micro Ervice theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
