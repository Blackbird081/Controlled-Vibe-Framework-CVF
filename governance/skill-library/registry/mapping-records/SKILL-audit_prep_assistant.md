# SKILL MAPPING RECORD — Audit Prep A I Tant

> **Skill ID:** audit_prep_assistant  
...
- Skill ID: audit_prep_assistant
- Skill Name: Audit Prep A I Tant
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/trailofbits/skills/tree/main/plugins/building-secure-contracts/skills/audit-prep-assistant
...
### 2.1 Core Capability
Audit Prep A I Tant theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
...
Risk level R2 phù hợp với domain Security Compliance và được ràng buộc bởi governance summary.
