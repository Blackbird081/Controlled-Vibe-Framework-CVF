# SKILL MAPPING RECORD — Backend Dev Guideline

> **Skill ID:** backend_dev_guidelines  
...
- Skill ID: backend_dev_guidelines
- Skill Name: Backend Dev Guideline
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/diet103/claude-code-infrastructure-showcase/tree/main/.claude/skills/backend-dev-guidelines
...
### 2.1 Core Capability
Backend Dev Guideline theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
