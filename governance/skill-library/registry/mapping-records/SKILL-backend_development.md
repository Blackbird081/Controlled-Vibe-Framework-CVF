# SKILL MAPPING RECORD — Backend Development

> **Skill ID:** backend_development  
...
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/mrgoonie/claudekit-skills/tree/main/.claude/skills/backend-development
...
### 2.1 Core Capability
Backend Development theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
