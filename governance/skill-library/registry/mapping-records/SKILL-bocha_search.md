# SKILL MAPPING RECORD — Bocha Earch

> **Skill ID:** bocha_search  
> **Domain:** Product Ux  
...
- Skill ID: bocha_search
- Skill Name: Bocha Earch
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/zhayujie/chatgpt-on-wechat/tree/master/skills/bocha-search
...
### 2.1 Core Capability
Bocha Earch theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
