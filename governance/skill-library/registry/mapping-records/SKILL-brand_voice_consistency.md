# SKILL MAPPING RECORD — Brand Voice Consistency

> **Skill ID:** brand_voice_consistency  
...
- Skill ID: brand_voice_consistency
- Skill Name: Brand Voice Consistency
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
Brand Voice Consistency theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Brand Name, Industry, Target Audience, Sample Content, Existing Guidelines, Competitors, Brand Values
