# SKILL MAPPING RECORD — Brow Er U E

> **Skill ID:** browser_use  
...
- Skill ID: browser_use
- Skill Name: Brow Er U E
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/browser-use/browser-use/tree/main/skills/browser-use
...
### 2.1 Core Capability
Brow Er U E theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
