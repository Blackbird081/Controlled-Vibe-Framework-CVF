# SKILL MAPPING RECORD — Building With Google Adk

> **Skill ID:** building_with_google_adk  
...
- Skill ID: building_with_google_adk
- Skill Name: Building With Google Adk
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/panaversity/agentfactory/tree/main/docs/_skills_archive/rare/building-with-google-adk
...
### 2.1 Core Capability
Building With Google Adk theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
...
Risk level R1 phù hợp với domain Ai Ml Evaluation và được ràng buộc bởi governance summary.
