...
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/ccxt/ccxt/tree/master/.claude/skills/ccxt-php
...
### 2.1 Core Capability
Ccxt Php theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
