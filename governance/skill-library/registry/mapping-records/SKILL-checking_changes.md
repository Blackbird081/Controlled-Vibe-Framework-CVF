# SKILL MAPPING RECORD — Checking Change

> **Skill ID:** checking_changes  
...
- Skill ID: checking_changes
- Skill Name: Checking Change
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/streamlit/streamlit/tree/develop/.claude/skills/checking-changes
...
### 2.1 Core Capability
Checking Change theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
