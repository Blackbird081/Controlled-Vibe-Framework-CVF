# SKILL MAPPING RECORD — Ci Monitor
...
- Skill ID: ci_monitor
- Skill Name: Ci Monitor
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/nrwl/nx/tree/master/.cursor/skills/ci-monitor
...
### 2.1 Core Capability
Ci Monitor theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
