# SKILL MAPPING RECORD — Clojure Review

> **Skill ID:** clojure_review  
...
- Skill ID: clojure_review
- Skill Name: Clojure Review
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/metabase/metabase/tree/master/.claude/skills/clojure-review
...
### 2.1 Core Capability
Clojure Review theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
