...
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/continuedev/continue/tree/main/skills/cn-check
...
### 2.1 Core Capability
Cn Check theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
