# SKILL MAPPING RECORD — Color Palette Generator

> **Skill ID:** color_palette_generator  
> **Domain:** Product & UX  
...
- Skill ID: color_palette_generator
- Skill Name: Color Palette Generator
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
Color Palette Generator theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Loại sản phẩm, Ngành, Mood, Existing colors, Dark/Light, Accessibility
