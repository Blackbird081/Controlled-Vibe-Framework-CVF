# SKILL MAPPING RECORD — Competitor Analysis

> **Skill ID:** competitor_analysis  
...
### 2.1 Core Capability
Competitor Analysis theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Công ty của bạn, Ngành/Industry, Top 3-5 Đối thủ, Tiêu chí so sánh, Mục tiêu phân tích
