# SKILL MAPPING RECORD — Component Refactoring

> **Skill ID:** component_refactoring  
...
- Skill ID: component_refactoring
- Skill Name: Component Refactoring
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/langgenius/dify/tree/main/.agents/skills/component-refactoring
...
### 2.1 Core Capability
Component Refactoring theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
