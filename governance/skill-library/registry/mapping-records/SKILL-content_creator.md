# SKILL MAPPING RECORD — Content Creator

> **Skill ID:** content_creator  
...
- Skill ID: content_creator
- Skill Name: Content Creator
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/alirezarezvani/claude-skills/tree/main/marketing-skill/content-creator
...
### 2.1 Core Capability
Content Creator theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
