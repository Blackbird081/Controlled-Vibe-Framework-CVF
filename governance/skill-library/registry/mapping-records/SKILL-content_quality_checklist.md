# SKILL MAPPING RECORD — Content Quality Checklist

> **Skill ID:** content_quality_checklist  
...
- Skill ID: content_quality_checklist
- Skill Name: Content Quality Checklist
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
Content Quality Checklist theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Content URL/Text, Content Type, Target Keyword, Target Audience, Content Goal, Competitor Content
