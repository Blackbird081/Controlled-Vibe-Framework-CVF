# SKILL MAPPING RECORD — Content Re Earch Writer

> **Skill ID:** content_research_writer  
...
- Skill ID: content_research_writer
- Skill Name: Content Re Earch Writer
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/ComposioHQ/awesome-claude-skills/tree/master/content-research-writer
...
### 2.1 Core Capability
Content Re Earch Writer theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Objective, Context, Constraints, Input Data, Output Format
- Required data sensitivity level: Public
...
Risk level R0 phù hợp với domain Content Creation và được ràng buộc bởi governance summary.
...
- Scope of impact: Minimal
- Reversibility: Easy
- Data exposure risk: Public
