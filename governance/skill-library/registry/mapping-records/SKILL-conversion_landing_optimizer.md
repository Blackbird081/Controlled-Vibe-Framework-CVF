# SKILL MAPPING RECORD — Conversion Landing Optimizer
...
### 2.1 Core Capability
Conversion Landing Optimizer theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: URL, Conversion goal, Current metrics, Traffic source, Audience, Competitors
