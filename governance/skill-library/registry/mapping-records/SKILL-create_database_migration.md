# SKILL MAPPING RECORD — Create Databa E Migration

> **Skill ID:** create_database_migration  
...
- Skill ID: create_database_migration
- Skill Name: Create Databa E Migration
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/TryGhost/Ghost/tree/main/.claude/skills/create-database-migration
...
### 2.1 Core Capability
Create Databa E Migration theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
