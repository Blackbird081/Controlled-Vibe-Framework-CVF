# SKILL MAPPING RECORD — Creating Financial Model

> **Skill ID:** creating_financial_models  
...
- Skill ID: creating_financial_models
- Skill Name: Creating Financial Model
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/anthropics/claude-cookbooks/tree/main/skills/custom_skills/creating-financial-models
...
### 2.1 Core Capability
Creating Financial Model theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
