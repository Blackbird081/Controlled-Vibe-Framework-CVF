# SKILL MAPPING RECORD — Dark/Light Mode Audit

> **Skill ID:** dark_light_mode_audit  
> **Domain:** Product & UX  
...
- Skill ID: dark_light_mode_audit
- Skill Name: Dark/Light Mode Audit
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
Dark/Light Mode Audit theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: URL/Code, Current modes, Framework, Key pages, Known issues
