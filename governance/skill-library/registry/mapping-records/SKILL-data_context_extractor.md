# SKILL MAPPING RECORD — Data Context Extractor

> **Skill ID:** data_context_extractor  
...
- Skill ID: data_context_extractor
- Skill Name: Data Context Extractor
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/anthropics/knowledge-work-plugins/tree/main/data/skills/data-context-extractor
...
### 2.1 Core Capability
Data Context Extractor theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
