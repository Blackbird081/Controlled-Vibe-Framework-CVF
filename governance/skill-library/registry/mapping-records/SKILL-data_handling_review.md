# SKILL MAPPING RECORD — Data Handling Review

> **Skill ID:** data_handling_review  
...
- Skill ID: data_handling_review
- Skill Name: Data Handling Review
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
Data Handling Review theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Data Types, Data Sources, Storage Systems, Data Flows, Current Controls, Regulations
