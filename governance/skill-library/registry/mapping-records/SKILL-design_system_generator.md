# SKILL MAPPING RECORD — Design System Generator

> **Skill ID:** design_system_generator  
> **Domain:** Product & UX  
...
- Skill ID: design_system_generator
- Skill Name: Design System Generator
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
Design System Generator theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Tên dự án, Loại sản phẩm, Ngành, Đối tượng, Tech stack, Pages chính, Brand assets, References
