# SKILL MAPPING RECORD — Doc Writer Reference

> **Skill ID:** docs_writer_reference  
...
- Skill ID: docs_writer_reference
- Skill Name: Doc Writer Reference
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/reactjs/react.dev/tree/main/.claude/skills/docs-writer-reference
...
### 2.1 Core Capability
Doc Writer Reference theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
