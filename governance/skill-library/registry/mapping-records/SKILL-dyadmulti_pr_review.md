# SKILL MAPPING RECORD — Dyadmulti Pr Review

> **Skill ID:** dyadmulti_pr_review  
...
- Skill ID: dyadmulti_pr_review
- Skill Name: Dyadmulti Pr Review
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/dyad-sh/dyad/tree/main/.claude/skills/multi-pr-review
...
### 2.1 Core Capability
Dyadmulti Pr Review theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
