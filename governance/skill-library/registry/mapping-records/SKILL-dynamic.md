...
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/popup-studio-ai/bkit-claude-code/tree/main/skills/dynamic
...
### 2.1 Core Capability
Dynamic theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
