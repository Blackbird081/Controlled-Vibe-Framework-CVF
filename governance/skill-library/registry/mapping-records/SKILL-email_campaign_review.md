# SKILL MAPPING RECORD — Email Campaign Review

> **Skill ID:** email_campaign_review  
...
- Skill ID: email_campaign_review
- Skill Name: Email Campaign Review
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
Email Campaign Review theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Email Content, Email Type, Target Audience, Campaign Goal, Current Metrics, Send Time
