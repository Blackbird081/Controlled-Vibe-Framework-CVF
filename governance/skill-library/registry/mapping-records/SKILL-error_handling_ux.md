# SKILL MAPPING RECORD — Error Handling UX

> **Skill ID:** error_handling_ux  
> **Domain:** Product & UX  
...
### 2.1 Core Capability
Error Handling UX theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Product/Feature, Error Types, Current Error Messages, Error Frequency, User Feedback
