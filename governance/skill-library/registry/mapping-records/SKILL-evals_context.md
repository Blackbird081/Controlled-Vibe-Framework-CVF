# SKILL MAPPING RECORD — Eval Context

> **Skill ID:** evals_context  
...
- Skill ID: evals_context
- Skill Name: Eval Context
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/RooCodeInc/Roo-Code/tree/main/.roo/skills/evals-context
...
### 2.1 Core Capability
Eval Context theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
