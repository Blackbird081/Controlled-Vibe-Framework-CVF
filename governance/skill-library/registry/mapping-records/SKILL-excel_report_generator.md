# SKILL MAPPING RECORD — Excel Report Generator

> **Skill ID:** excel_report_generator  
...
- Skill ID: excel_report_generator
- Skill Name: Excel Report Generator
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/wwwzhouhui/skills_collection/tree/main/excel-report-generator
...
### 2.1 Core Capability
Excel Report Generator theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
...
Risk level R1 phù hợp với domain Business Analysis và được ràng buộc bởi governance summary.
