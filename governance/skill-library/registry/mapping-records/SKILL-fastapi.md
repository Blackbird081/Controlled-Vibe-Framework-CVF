...
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/srbhr/Resume-Matcher/tree/main/.agent/skills/fastapi
...
### 2.1 Core Capability
Fa Tapi theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
