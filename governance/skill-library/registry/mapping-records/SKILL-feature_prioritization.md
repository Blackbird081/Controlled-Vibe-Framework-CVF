# SKILL MAPPING RECORD — Feature Prioritization (RICE/ICE)

> **Skill ID:** feature_prioritization  
> **Domain:** Product & UX  
...
- Skill ID: feature_prioritization
- Skill Name: Feature Prioritization (RICE/ICE)
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
Feature Prioritization (RICE/ICE) theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Feature List, Company Goals, Framework, Time Horizon, Team Capacity, Dependencies
