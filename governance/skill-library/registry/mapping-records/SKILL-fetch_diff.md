# SKILL MAPPING RECORD — Fetch Diff
...
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/mlflow/mlflow/tree/master/.claude/skills/fetch-diff
...
### 2.1 Core Capability
Fetch Diff theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
