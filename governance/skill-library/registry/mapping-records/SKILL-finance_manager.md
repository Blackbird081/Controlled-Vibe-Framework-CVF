# SKILL MAPPING RECORD — Finance Manager

> **Skill ID:** finance_manager  
...
- Skill ID: finance_manager
- Skill Name: Finance Manager
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/ailabs-393/ai-labs-claude-skills/tree/main/dist/skills/finance-manager
...
### 2.1 Core Capability
Finance Manager theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
