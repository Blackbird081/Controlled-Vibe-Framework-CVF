# SKILL MAPPING RECORD — GDPR Compliance Review

> **Skill ID:** gdpr_compliance_review  
...
- Skill ID: gdpr_compliance_review
- Skill Name: GDPR Compliance Review
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
GDPR Compliance Review theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Website/App, Data Collected, Processing Purpose, Third Parties, User Geography, Current Measures
