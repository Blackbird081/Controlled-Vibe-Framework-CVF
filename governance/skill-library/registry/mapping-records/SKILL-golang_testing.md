# SKILL MAPPING RECORD — Golang Te Ting

> **Skill ID:** golang_testing  
...
- Skill ID: golang_testing
- Skill Name: Golang Te Ting
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/affaan-m/everything-claude-code/tree/main/docs/zh-CN/skills/golang-testing
...
### 2.1 Core Capability
Golang Te Ting theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
