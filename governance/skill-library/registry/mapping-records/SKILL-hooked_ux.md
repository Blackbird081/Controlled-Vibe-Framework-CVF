# SKILL MAPPING RECORD — Hooked Ux
...
- Skill ID: hooked_ux
- Skill Name: Hooked Ux
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/wondelai/skills/tree/main/hooked-ux
...
### 2.1 Core Capability
Hooked Ux theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
