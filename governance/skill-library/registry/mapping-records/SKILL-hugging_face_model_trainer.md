# SKILL MAPPING RECORD — Hugging Face Model Trainer

> **Skill ID:** hugging_face_model_trainer  
...
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/patchy631/ai-engineering-hub/tree/main/hugging-face-skills/skills/hugging-face-model-trainer
...
### 2.1 Core Capability
Hugging Face Model Trainer theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
