# SKILL MAPPING RECORD — Incident Response Plan

> **Skill ID:** incident_response_plan  
...
- Skill ID: incident_response_plan
- Skill Name: Incident Response Plan
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
Incident Response Plan theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Company Size, Industry, Current Plan, Past Incidents, Critical Systems, Team Structure
