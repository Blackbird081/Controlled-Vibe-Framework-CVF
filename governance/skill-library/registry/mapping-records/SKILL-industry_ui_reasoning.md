# SKILL MAPPING RECORD — Industry UI Reasoning

> **Skill ID:** industry_ui_reasoning  
...
- Skill ID: industry_ui_reasoning
- Skill Name: Industry UI Reasoning
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
Industry UI Reasoning theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Ngành, Loại sản phẩm, Đối tượng, Competitors, Region
