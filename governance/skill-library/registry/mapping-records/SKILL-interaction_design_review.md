# SKILL MAPPING RECORD — Interaction Design Review

> **Skill ID:** interaction_design_review  
> **Domain:** Product & UX  
...
- Skill ID: interaction_design_review
- Skill Name: Interaction Design Review
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
Interaction Design Review theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: URL/Code, Platform, Key flows, Known issues, Target devices
