# SKILL MAPPING RECORD — Jazz Permi Ion Ecurity

> **Skill ID:** jazz_permissions_security  
...
- Skill ID: jazz_permissions_security
- Skill Name: Jazz Permi Ion Ecurity
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/garden-co/jazz/tree/main/.cursor/skills/jazz-permissions-security
...
### 2.1 Core Capability
Jazz Permi Ion Ecurity theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
