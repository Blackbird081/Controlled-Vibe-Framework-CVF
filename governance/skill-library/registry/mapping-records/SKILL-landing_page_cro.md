# SKILL MAPPING RECORD — Landing Page CRO

> **Skill ID:** landing_page_cro  
...
### 2.1 Core Capability
Landing Page CRO theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Landing Page URL, Mục tiêu conversion, Target Audience, Traffic Source, Current Conversion Rate, Industry Benchmark
