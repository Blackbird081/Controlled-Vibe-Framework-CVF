# SKILL MAPPING RECORD — Marketing Demand Acqui Ition

> **Skill ID:** marketing_demand_acquisition  
...
- Skill ID: marketing_demand_acquisition
- Skill Name: Marketing Demand Acqui Ition
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/ynulihao/AgentSkillOS/tree/main/data/skill_seeds/marketing-demand-acquisition
...
### 2.1 Core Capability
Marketing Demand Acqui Ition theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
