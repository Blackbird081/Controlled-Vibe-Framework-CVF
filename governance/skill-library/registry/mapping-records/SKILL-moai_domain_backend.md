# SKILL MAPPING RECORD — Moai Domain Backend

> **Skill ID:** moai_domain_backend  
...
- Skill ID: moai_domain_backend
- Skill Name: Moai Domain Backend
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/modu-ai/moai-adk/tree/main/.claude/skills/moai-domain-backend
...
### 2.1 Core Capability
Moai Domain Backend theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
