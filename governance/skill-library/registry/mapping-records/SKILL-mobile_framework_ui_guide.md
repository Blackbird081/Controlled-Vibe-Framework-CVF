# SKILL MAPPING RECORD — Mobile Framework UI Guide

> **Skill ID:** mobile_framework_ui_guide  
...
- Skill ID: mobile_framework_ui_guide
- Skill Name: Mobile Framework UI Guide
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
Mobile Framework UI Guide theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Framework, App type, Key screens, Experience, Design system
