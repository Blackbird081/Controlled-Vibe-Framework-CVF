# SKILL MAPPING RECORD — Montecarlo
...
- Skill ID: montecarlo
- Skill Name: Montecarlo
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/AojdevStudio/Finance-Guru/tree/main/.claude/skills/MonteCarlo
...
### 2.1 Core Capability
Montecarlo theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
