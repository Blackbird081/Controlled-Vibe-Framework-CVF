# SKILL MAPPING RECORD — Multi Reviewer Pattern

> **Skill ID:** multi_reviewer_patterns  
...
- Skill ID: multi_reviewer_patterns
- Skill Name: Multi Reviewer Pattern
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/wshobson/agents/tree/main/plugins/agent-teams/skills/multi-reviewer-patterns
...
### 2.1 Core Capability
Multi Reviewer Pattern theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
