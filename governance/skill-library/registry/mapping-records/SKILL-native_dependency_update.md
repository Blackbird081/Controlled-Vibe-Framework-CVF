# SKILL MAPPING RECORD — Native Dependency Update

> **Skill ID:** native_dependency_update  
...
- Skill ID: native_dependency_update
- Skill Name: Native Dependency Update
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/mono/SkiaSharp/tree/main/.github/skills/native-dependency-update
...
### 2.1 Core Capability
Native Dependency Update theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
