# SKILL MAPPING RECORD — Onboarding Experience Review

> **Skill ID:** onboarding_experience_review  
> **Domain:** Product & UX  
...
- Skill ID: onboarding_experience_review
- Skill Name: Onboarding Experience Review
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
Onboarding Experience Review theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Product Type, Current Onboarding Steps, Activation Metric, Time to Value, Drop-off Data, User Feedback
...
Risk level R1 phù hợp với domain Product & UX và được ràng buộc bởi governance summary.
