# SKILL MAPPING RECORD — Onchainkit
...
- Skill ID: onchainkit
- Skill Name: Onchainkit
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/BankrBot/openclaw-skills/tree/main/onchainkit
...
### 2.1 Core Capability
Onchainkit theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
