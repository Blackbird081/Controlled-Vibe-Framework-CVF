# SKILL MAPPING RECORD — Penpot Uiux De Ign

> **Skill ID:** penpot_uiux_design  
...
- Skill ID: penpot_uiux_design
- Skill Name: Penpot Uiux De Ign
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/github/awesome-copilot/tree/main/skills/penpot-uiux-design
...
### 2.1 Core Capability
Penpot Uiux De Ign theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
