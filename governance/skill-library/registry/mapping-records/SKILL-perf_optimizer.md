# SKILL MAPPING RECORD — Perf Optimizer

> **Skill ID:** perf_optimizer  
...
- Skill ID: perf_optimizer
- Skill Name: Perf Optimizer
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/OneKeyHQ/app-monorepo/tree/x/.claude/skills/perf-optimizer
...
### 2.1 Core Capability
Perf Optimizer theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
