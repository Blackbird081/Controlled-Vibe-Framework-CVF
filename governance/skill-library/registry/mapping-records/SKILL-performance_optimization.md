# SKILL MAPPING RECORD — Performance Optimization

> **Skill ID:** performance_optimization  
...
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/FarhanAliRaza/django-bolt/tree/master/.claude/performance-optimization
...
### 2.1 Core Capability
Performance Optimization theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
