# SKILL MAPPING RECORD — Pr Finalize

> **Skill ID:** pr_finalize  
...
- Skill ID: pr_finalize
- Skill Name: Pr Finalize
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/dotnet/maui/tree/main/.github/skills/pr-finalize
...
### 2.1 Core Capability
Pr Finalize theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
