# SKILL MAPPING RECORD — Pricing Strategy Review

> **Skill ID:** pricing_strategy_review  
...
- Skill ID: pricing_strategy_review
- Skill Name: Pricing Strategy Review
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
Pricing Strategy Review theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Sản phẩm/Dịch vụ, Giá hiện tại, Pricing Model, Target Customer, Chi phí (COGS), Giá đối thủ, Mục tiêu
