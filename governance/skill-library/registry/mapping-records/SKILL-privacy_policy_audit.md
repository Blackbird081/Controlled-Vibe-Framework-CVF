# SKILL MAPPING RECORD — Privacy Policy Audit

> **Skill ID:** privacy_policy_audit  
...
- Skill ID: privacy_policy_audit
- Skill Name: Privacy Policy Audit
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
Privacy Policy Audit theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Current Policy URL, Business Type, Target Markets, Data Collected, Third Party Services, Special Data
