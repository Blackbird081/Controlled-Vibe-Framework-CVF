# SKILL MAPPING RECORD — Product Page Style Matcher

> **Skill ID:** product_page_style_matcher  
...
- Skill ID: product_page_style_matcher
- Skill Name: Product Page Style Matcher
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
Product Page Style Matcher theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Sản phẩm/dịch vụ, Ngành, Đối tượng, Budget feel, References
