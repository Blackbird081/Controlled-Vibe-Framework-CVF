# SKILL MAPPING RECORD — Promptfoo Evaluation

> **Skill ID:** promptfoo_evaluation  
...
- Skill ID: promptfoo_evaluation
- Skill Name: Promptfoo Evaluation
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/daymade/claude-code-skills/tree/main/promptfoo-evaluation
...
### 2.1 Core Capability
Promptfoo Evaluation theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
