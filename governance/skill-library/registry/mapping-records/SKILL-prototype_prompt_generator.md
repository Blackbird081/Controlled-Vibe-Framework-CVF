# SKILL MAPPING RECORD — Prototype Prompt Generator

> **Skill ID:** prototype_prompt_generator  
...
- Skill ID: prototype_prompt_generator
- Skill Name: Prototype Prompt Generator
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/cexll/myclaude/tree/master/skills/prototype-prompt-generator
...
### 2.1 Core Capability
Prototype Prompt Generator theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
