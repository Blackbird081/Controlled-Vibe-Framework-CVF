# SKILL MAPPING RECORD — Python Expert

> **Skill ID:** python_expert  
...
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/Shubhamsaboo/awesome-llm-apps/tree/main/awesome_agent_skills/python-expert
...
### 2.1 Core Capability
Python Expert theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
