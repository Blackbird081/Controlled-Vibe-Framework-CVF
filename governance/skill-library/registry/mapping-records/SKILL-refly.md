...
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/refly-ai/refly/tree/main/packages/cli/skill
...
### 2.1 Core Capability
Refly theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
