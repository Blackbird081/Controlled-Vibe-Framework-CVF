# SKILL MAPPING RECORD — SEO Audit
...
### 2.1 Core Capability
SEO Audit theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: URL Website, Ngành/Lĩnh vực, Target Keywords, Đối thủ chính, Mục tiêu SEO
