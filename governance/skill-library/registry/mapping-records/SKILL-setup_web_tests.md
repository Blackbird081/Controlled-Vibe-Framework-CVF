# SKILL MAPPING RECORD — Etup Web Te T

> **Skill ID:** setup_web_tests  
...
- Skill ID: setup_web_tests
- Skill Name: Etup Web Te T
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/PostHog/posthog/tree/master/.claude/skills/setup-web-tests
...
### 2.1 Core Capability
Etup Web Te T theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
