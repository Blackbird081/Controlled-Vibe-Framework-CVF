# SKILL MAPPING RECORD — Social Media Ad Review

> **Skill ID:** social_media_ad_review  
...
- Skill ID: social_media_ad_review
- Skill Name: Social Media Ad Review
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
Social Media Ad Review theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Ad Creative, Ad Copy, Platform, Campaign Objective, Target Audience, Landing Page URL, Current Performance
