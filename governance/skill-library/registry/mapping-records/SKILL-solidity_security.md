# SKILL MAPPING RECORD — Olidity Ecurity

> **Skill ID:** solidity_security  
...
- Skill ID: solidity_security
- Skill Name: Olidity Ecurity
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/scaffold-eth/scaffold-eth-2/tree/main/.agents/skills/solidity-security
...
### 2.1 Core Capability
Olidity Ecurity theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
