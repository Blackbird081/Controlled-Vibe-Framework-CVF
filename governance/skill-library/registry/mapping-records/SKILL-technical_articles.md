# SKILL MAPPING RECORD — Technical Article

> **Skill ID:** technical_articles  
...
- Skill ID: technical_articles
- Skill Name: Technical Article
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/EpicenterHQ/epicenter/tree/main/.agents/skills/technical-articles
...
### 2.1 Core Capability
Technical Article theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
