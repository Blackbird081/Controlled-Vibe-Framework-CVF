# SKILL MAPPING RECORD — Terms of Service Review

> **Skill ID:** terms_of_service_review  
...
- Skill ID: terms_of_service_review
- Skill Name: Terms of Service Review
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
Terms of Service Review theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Current ToS URL, Service Type, Business Model, Target Markets, Key Risks, User Types
