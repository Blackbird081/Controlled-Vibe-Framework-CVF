# SKILL MAPPING RECORD — Te Ting Python

> **Skill ID:** testing_python  
...
- Skill ID: testing_python
- Skill Name: Te Ting Python
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/jlowin/fastmcp/tree/main/.claude/skills/python-tests
...
### 2.1 Core Capability
Te Ting Python theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
