# SKILL MAPPING RECORD — Typography Pairing

> **Skill ID:** typography_pairing  
> **Domain:** Product & UX  
...
### 2.1 Core Capability
Typography Pairing theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Mood, Ngành, Content type, Language, Performance, Existing font
