# SKILL MAPPING RECORD — UI Pre-Delivery Checklist

> **Skill ID:** ui_pre_delivery_checklist  
...
- Skill ID: ui_pre_delivery_checklist
- Skill Name: UI Pre-Delivery Checklist
- Version: 1.0.0
- Source:
...
### 2.1 Core Capability
UI Pre-Delivery Checklist theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: URL/Code, Pages changed, Framework, Dark mode
