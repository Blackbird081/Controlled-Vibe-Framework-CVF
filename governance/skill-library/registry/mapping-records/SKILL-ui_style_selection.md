# SKILL MAPPING RECORD — UI Style Selection

> **Skill ID:** ui_style_selection  
> **Domain:** Product & UX  
...
### 2.1 Core Capability
UI Style Selection theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Loại sản phẩm, Ngành, Đối tượng, Mood keywords, Platform, Dark/Light
