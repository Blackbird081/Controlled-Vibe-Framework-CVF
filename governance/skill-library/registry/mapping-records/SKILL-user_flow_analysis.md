# SKILL MAPPING RECORD — User Flow Analysis

> **Skill ID:** user_flow_analysis  
> **Domain:** Product & UX  
...
### 2.1 Core Capability
User Flow Analysis theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Flow Name, Start Point, End Goal, Steps Có, Conversion Data, User Feedback, Competitor Flow
