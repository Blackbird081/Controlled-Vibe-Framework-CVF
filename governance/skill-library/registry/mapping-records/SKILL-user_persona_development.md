# SKILL MAPPING RECORD — User Persona Development

> **Skill ID:** user_persona_development  
> **Domain:** Product & UX  
...
### 2.1 Core Capability
User Persona Development theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Product/Service, Market/Industry, Existing User Data, Number of Personas, Existing Personas, Business Goals
