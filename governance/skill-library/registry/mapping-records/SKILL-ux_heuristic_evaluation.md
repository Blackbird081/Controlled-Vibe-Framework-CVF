# SKILL MAPPING RECORD — UX Heuristic Evaluation

> **Skill ID:** ux_heuristic_evaluation  
> **Domain:** Product & UX  
...
- Skill ID: ux_heuristic_evaluation
- Skill Name: UX Heuristic Evaluation
- Version: 1.0.1
- Source:
...
### 2.1 Core Capability
UX Heuristic Evaluation theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.

### 2.2 Inputs
- Input types: Product URL/Screenshots, Product Type, Target Users, Key Tasks, Known Issues, Competitor
