# SKILL MAPPING RECORD — Ux Writing
...
- Skill ID: ux_writing
- Skill Name: Ux Writing
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/content-designer/ux-writing-skill
...
### 2.1 Core Capability
Ux Writing theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
