# SKILL MAPPING RECORD — Vercel React Be T Practice

> **Skill ID:** vercel_react_best_practices  
...
- Skill ID: vercel_react_best_practices
- Skill Name: Vercel React Be T Practice
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/lobehub/lobehub/tree/main/.agents/skills/vercel-react-best-practices
...
### 2.1 Core Capability
Vercel React Be T Practice theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
