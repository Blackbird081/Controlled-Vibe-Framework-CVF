...
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/IgorWarzocha/Opencode-Workflows/tree/master/cowork/.opencode/skill/word
...
### 2.1 Core Capability
Word theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
