# SKILL MAPPING RECORD — Write Relea E Note

> **Skill ID:** write_release_notes  
...
- Skill ID: write_release_notes
- Skill Name: Write Relea E Note
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/tldraw/tldraw/tree/main/.claude/skills/write-release-notes
...
### 2.1 Core Capability
Write Relea E Note theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
