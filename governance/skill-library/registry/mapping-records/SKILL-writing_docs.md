# SKILL MAPPING RECORD — Writing Doc

> **Skill ID:** writing_docs  
...
- Skill ID: writing_docs
- Skill Name: Writing Doc
- Version: 1.0.0
- Source:
  - URL / Repository: https://github.com/remotion-dev/remotion/tree/main/.claude/skills/writing-docs
...
### 2.1 Core Capability
Writing Doc theo chuẩn CVF, tạo output có cấu trúc và giới hạn phạm vi.
