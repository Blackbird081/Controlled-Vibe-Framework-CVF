...
def build_payload(anchor: dict[str, Any], corpus_task: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "anchor": {
            ...
            "reviewer_quality": anchor["reviewer_quality"],
            "reviewer_rework": anchor["reviewer_rework"],
            "reviewer_rationales": anchor["reviewer_rationales"],
...
def main() -> int:
    ...
    for anchor in target_anchors:
        print(f"QBS16 adjudicating {anchor['anchor_id']} {anchor['output_id']}", flush=True)
    ...
    payload = {
        ...
        "claim_boundary": "This artifact does not mutate R5/R6/R7 scores and does not create a public QBS claim.",
