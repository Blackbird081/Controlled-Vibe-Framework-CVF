#!/usr/bin/env python3
"""
Regenerate runtime evidence artifacts and validate cross-family packet coverage against the manifest.
"""
...
def main() -> int:
    if os.environ.get("CVF_SKIP_RUNTIME_EVIDENCE_RELEASE_GATE") != "1":
        ...
        _run([sys.executable, str(EXPORT_PACKET), "--output", str(PACKET_PATH)])
